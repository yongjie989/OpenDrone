...
# 54 "./src/main/sensors/compass.c" 2
...
const compassConfig_t pgResetTemplate_compassConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .mag_align = ALIGN_DEFAULT, .mag_hardware = MAG_NONE, .mag_declination = 0, .mag_to_use = 0, .magCalibrationTimeLimit = 30, .rollDeciDegrees = 0, .pitchDeciDegrees = 0, .yawDeciDegrees = 0, }
# 79 "./src/main/sensors/compass.c"
 ;
