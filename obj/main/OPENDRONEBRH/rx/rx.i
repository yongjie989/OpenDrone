...
static 
# 172 "./src/main/rx/rx.c" 3 4
      _Bool 
# 172 "./src/main/rx/rx.c"
...
# 179 "./src/main/rx/rx.c" 3 4
_Bool 
# 179 "./src/main/rx/rx.c"
    serialRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    
# 181 "./src/main/rx/rx.c" 3 4
   _Bool 
# 181 "./src/main/rx/rx.c"
        enabled = 
# 181 "./src/main/rx/rx.c" 3 4
                  0
# 181 "./src/main/rx/rx.c"
...
# 243 "./src/main/rx/rx.c" 3 4
                                      0
# 243 "./src/main/rx/rx.c"
                                           ;
    rcSampleIndex = 0;
...
# 339 "./src/main/rx/rx.c" 3 4
   _Bool 
# 339 "./src/main/rx/rx.c"
...
# 364 "./src/main/rx/rx.c" 3 4
_Bool 
# 364 "./src/main/rx/rx.c"
    rxIsReceivingSignal(void)
{
...
# 388 "./src/main/rx/rx.c" 3 4
_Bool 
# 388 "./src/main/rx/rx.c"
    rxUpdateCheck(timeUs_t currentTimeUs, timeDelta_t currentDeltaTime)
{
...
# 416 "./src/main/rx/rx.c"
    {
        ...
        if (frameStatus & RX_FRAME_COMPLETE) {
            rxDataProcessingRequired = 
# 419 "./src/main/rx/rx.c" 3 4
                                      1
# 419 "./src/main/rx/rx.c"
                                          ;
...
# 426 "./src/main/rx/rx.c"
    ...
    if (cmpTimeUs(currentTimeUs, rxNextUpdateAtUs) > 0) {
        rxDataProcessingRequired = 
# 431 "./src/main/rx/rx.c" 3 4
                                  1
# 431 "./src/main/rx/rx.c"
                                      ;
    }
...
# 441 "./src/main/rx/rx.c"
    ...
    if (!rxSamplesCollected) {
        ...
        rxSamplesCollected = 
# 451 "./src/main/rx/rx.c" 3 4
                            1
# 451 "./src/main/rx/rx.c"
                                ;
    }
...
void calculateRxChannelsAndUpdateFailsafe(timeUs_t currentTimeUs)
{
    ...
    if (!rxDataProcessingRequired) {
        return 
# 481 "./src/main/rx/rx.c" 3 4
              0
# 481 "./src/main/rx/rx.c"
                   ;
    }

    rxDataProcessingRequired = 
# 484 "./src/main/rx/rx.c" 3 4
                              0
# 484 "./src/main/rx/rx.c"
                                   ;
    ...
    if (skipRxSamples) {
        ...
        return 
# 493 "./src/main/rx/rx.c" 3 4
              1
# 493 "./src/main/rx/rx.c"
                  ;
    }

    rxFlightChannelsValid = 
# 496 "./src/main/rx/rx.c" 3 4
                           1
# 496 "./src/main/rx/rx.c"
                               ;
    ...
    for (int channel = 0; channel < rxRuntimeConfig.channelCount; channel++) {
        ...
        if (!isPulseValid(sample)) {
            ...
            if ((currentTimeMs > rcInvalidPulsPeriod[channel]) && (channel < 4)) {
                rxFlightChannelsValid = 
# 518 "./src/main/rx/rx.c" 3 4
                                       0
# 518 "./src/main/rx/rx.c"
                                            ;
            }
        } else {
...
# 610 "./src/main/rx/rx.c" 3 4
                                                0
# 610 "./src/main/rx/rx.c"
                                                     );
...
# 612 "./src/main/rx/rx.c"
    ...
    return 
# 614 "./src/main/rx/rx.c" 3 4
          0
# 614 "./src/main/rx/rx.c"
               ;
}

static 
# 617 "./src/main/rx/rx.c" 3 4
      _Bool 
# 617 "./src/main/rx/rx.c"
           updateRSSIADC(void)
{

    uint16_t rawRSSI = adcGetChannel(ADC_RSSI) / 4;
    setRSSI(rawRSSI, RSSI_SOURCE_ADC, 
# 621 "./src/main/rx/rx.c" 3 4
                                     0
# 621 "./src/main/rx/rx.c"
                                          );
    return 
