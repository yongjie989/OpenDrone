...
extern const timeConfig_t pgResetTemplate_timeConfig; timeConfig_t timeConfig_System; timeConfig_t timeConfig_Copy; extern const pgRegistry_t timeConfig_Registry; const pgRegistry_t timeConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 1011 | (0 << 12), .size = sizeof(timeConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&timeConfig_System, .copy = (uint8_t*)&timeConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_timeConfig}, };

const timeConfig_t pgResetTemplate_timeConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .tz_offset = 0, }
...
static 
# 112 "./src/main/common/time.c" 3 4
      _Bool 
# 112 "./src/main/common/time.c"
...
static 
# 130 "./src/main/common/time.c" 3 4
      _Bool 
# 130 "./src/main/common/time.c"
...
# 136 "./src/main/common/time.c" 3 4
   _Bool 
# 136 "./src/main/common/time.c"
        retVal = 
# 136 "./src/main/common/time.c" 3 4
                 1
# 136 "./src/main/common/time.c"
    ...
    if (!rtcIsDateTimeValid(dateTime)) {
        ...
        dateTime = &local;
        retVal = 
# 149 "./src/main/common/time.c" 3 4
                0
# 149 "./src/main/common/time.c"
                     ;
    }
...
# 177 "./src/main/common/time.c" 3 4
_Bool 
# 177 "./src/main/common/time.c"
    dateTimeFormatUTC(char *buf, dateTime_t *dt)
{
    ...
    rtcGet(rtcTime_t *t)
{
    if (!rtcHasTime()) {
        return 
# 215 "./src/main/common/time.c" 3 4
              0
# 215 "./src/main/common/time.c"
                   ;
    }
    *t = started + millis();
    return 
# 218 "./src/main/common/time.c" 3 4
          1
# 218 "./src/main/common/time.c"
              ;
}
...
# 232 "./src/main/common/time.c"
    ...
    return 
# 236 "./src/main/common/time.c" 3 4
          0
# 236 "./src/main/common/time.c"
               ;
}


# 239 "./src/main/common/time.c" 3 4
_Bool 
# 239 "./src/main/common/time.c"
    rtcSetDateTime(dateTime_t *dt)
{
