...
## arm_sdk_install   : Install ARM SDK(toolchain)
...
## arm_sdk_clean     : Uninstall ARM(toolchain)
.PHONY: arm_sdk_clean
arm_sdk_clean:
...
ifeq ($(shell [ -d "$(ARM_SDK_DIR)" ] && echo "exists"), exists)
  ...
  ifeq ($(GCC_VERSION),)
    ...
    $(error **ERROR** your arm-none-eabi-gcc is '$(GCC_VERSION)', but '$(GCC_REQUIRED_VERSION)' is expected. Please run 'make arm_sdk_install' to install the right version automatically in the tools folder. )
  endif
