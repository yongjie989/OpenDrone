...
# 104 "./src/main/drivers/rx_pwm.c" 3 4
   _Bool 
# 104 "./src/main/drivers/rx_pwm.c"
            overflowed;
} ppmDevice_t;
...
# 118 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 118 "./src/main/drivers/rx_pwm.c"
    isPPMDataBeingReceived(void)
{
...
static void ppmOverflowCallback(timerOvrHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    if (capture == 0x10000 - 1) {
        ppmDev.overflowed = 
# 181 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 181 "./src/main/drivers/rx_pwm.c"
                               ;
    }
}
...
static void ppmEdgeCallback(timerCCHandlerRec_t* cbRec, captureCompare_t capture)
{
    ...
    ppmDev.overflowed = 
# 217 "./src/main/drivers/rx_pwm.c" 3 4
                       0
# 217 "./src/main/drivers/rx_pwm.c"
                            ;
    ...
    if (ppmDev.deltaTime > 2700) {
        ...
        ppmDev.tracking = 
# 271 "./src/main/drivers/rx_pwm.c" 3 4
                           1
# 271 "./src/main/drivers/rx_pwm.c"
                               ;
        ...
        if (ppmDev.deltaTime > 750
            ...
            ppmDev.tracking = 
# 286 "./src/main/drivers/rx_pwm.c" 3 4
                             0
# 286 "./src/main/drivers/rx_pwm.c"
                                  ;
            for (i = 0; i < 16; i++) {
                ppmDev.captures[i] = 0;
            }
...
# 296 "./src/main/drivers/rx_pwm.c" 3 4
_Bool 
# 296 "./src/main/drivers/rx_pwm.c"
    isPWMDataBeingReceived(void)
{
    int channel;
    for (channel = 0; channel < 16; channel++) {
        if (captures[channel] != 0) {
            return 
# 301 "./src/main/drivers/rx_pwm.c" 3 4
                  1
# 301 "./src/main/drivers/rx_pwm.c"
                      ;
        }
    }
    return 
# 304 "./src/main/drivers/rx_pwm.c" 3 4
          0
# 304 "./src/main/drivers/rx_pwm.c"
               ;
}
...
# 310 "./src/main/drivers/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 310 "./src/main/drivers/rx_pwm.c"
                                  pwmInputPort_t
# 310 "./src/main/drivers/rx_pwm.c" 3 4
                                  , 
# 310 "./src/main/drivers/rx_pwm.c"
...
# 320 "./src/main/drivers/rx_pwm.c" 3 4
                                  __builtin_offsetof (
# 320 "./src/main/drivers/rx_pwm.c"
                                  pwmInputPort_t
# 320 "./src/main/drivers/rx_pwm.c" 3 4
                                  , 
# 320 "./src/main/drivers/rx_pwm.c"
