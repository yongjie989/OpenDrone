...
# 194 "./src/main/io/beeper.c"
     ,"SYSTEM_INIT" },
    { BEEPER_USB,18,
# 195 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 195 "./src/main/io/beeper.c"
     ,"ON_USB" },
    ...
    { BEEPER_ALL,22,
# 200 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 200 "./src/main/io/beeper.c"
     ,"ALL" },
    { BEEPER_PREFERENCE,23,
# 201 "./src/main/io/beeper.c" 3 4
     ((void *)0)
# 201 "./src/main/io/beeper.c"
     ,"PREFERED" },
};

static const beeperTableEntry_t *currentBeeperEntry = 
# 204 "./src/main/io/beeper.c" 3 4
                                                     ((void *)0)
# 204 "./src/main/io/beeper.c"
                                                         ;
...
# 250 "./src/main/io/beeper.c"
    ...
    currentBeeperEntry = 
# 260 "./src/main/io/beeper.c" 3 4
                        ((void *)0)
# 260 "./src/main/io/beeper.c"
                            ;
}
...
void beeperUpdate(timeUs_t currentTimeUs)
{
    ...
    if (currentBeeperEntry == 
# 329 "./src/main/io/beeper.c" 3 4
                             ((void *)0)
# 329 "./src/main/io/beeper.c"
                                 ) {
        return;
    }
    ...
    if (!beeperIsOn) {
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            if (!(getBeeperOffMask() & (1 << (currentBeeperEntry->mode - 1))))
                systemBeep(
# 342 "./src/main/io/beeper.c" 3 4
               1
# 342 "./src/main/io/beeper.c"
               );
        ...
        if (currentBeeperEntry->sequence[beeperPos] != 0) {
            systemBeep(
# 357 "./src/main/io/beeper.c" 3 4
           0
# 357 "./src/main/io/beeper.c"
           );
            warningLedDisable();
            warningLedRefresh();
        }
