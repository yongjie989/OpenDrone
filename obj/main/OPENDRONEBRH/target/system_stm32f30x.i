...
# 145 "./src/main/target/system_stm32f30x.c"
...
# 220 "./src/main/target/system_stm32f30x.c"
...
# 272 "./src/main/target/system_stm32f30x.c"
void SetSysClock(uint8_t underclock)
{
  ...
  if (HSEStatus == (uint32_t)0x01)
  {
    ...
    if (!underclock) {
        ...
        if (8000000 == 12000000) {
            ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR |= (uint32_t)(((uint32_t)0x00010000) | ((uint32_t)0x00000000) | ((uint32_t)0x00080000));
        }
        else {
            ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00001000))->CFGR |= (uint32_t)(((uint32_t)0x00010000) | ((uint32_t)0x00000000) | ((uint32_t)0x00100000));
        }
