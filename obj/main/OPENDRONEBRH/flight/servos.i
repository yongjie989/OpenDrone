...
{
    for (int i = 0; i < 8; i++) {
        static const servoParam_t _reset_template_84 = { .min = 1000, .max = 2000, .middle = 1500, .rate = 100, .forwardFromChannel = (uint8_t)0xFF }; memcpy((&instance[i]), &_reset_template_84, sizeof(*(&instance[i])));
...
static 
# 102 "./src/main/flight/servos.c" 3 4
      _Bool 
# 102 "./src/main/flight/servos.c"
           servoFilterIsSet;
...
const mixerRules_t servoMixers[] = {
    { 0, 0, 0, 
# 138 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 138 "./src/main/flight/servos.c"
                   },
    { (sizeof(servoMixerTri) / sizeof(servoMixer_t)), SERVO_RUDDER, SERVO_RUDDER, servoMixerTri },
    { 0, 0, 0, 
# 140 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 140 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 141 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 141 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 142 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 142 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 143 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 143 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 144 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 144 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 145 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 145 "./src/main/flight/servos.c"
                   },
    { (sizeof(servoMixerFlyingWing) / sizeof(servoMixer_t)), SERVO_FLAPPERON_1, SERVO_FLAPPERON_2, servoMixerFlyingWing },
    { 0, 0, 0, 
# 147 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 147 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 148 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 148 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 149 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 149 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 150 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 150 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 151 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 151 "./src/main/flight/servos.c"
                   },
    { (sizeof(servoMixerAirplane) / sizeof(servoMixer_t)), SERVO_ELEVATOR, SERVO_RUDDER, servoMixerAirplane },
    { 0, 0, 0, 
# 153 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 153 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 154 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 154 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 155 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 155 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 156 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 156 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 157 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 157 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 158 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 158 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 159 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 159 "./src/main/flight/servos.c"
                   },
    { 0, 0, 0, 
# 160 "./src/main/flight/servos.c" 3 4
              ((void *)0) 
# 160 "./src/main/flight/servos.c"
                   },
    { 0, 2, 5, 
...
# 161 "./src/main/flight/servos.c"
    ...
    { 0, SERVO_ELEVATOR, SERVO_RUDDER, 
# 162 "./src/main/flight/servos.c" 3 4
                                                      ((void *)0) 
# 162 "./src/main/flight/servos.c"
                                                           },
    { 0, SERVO_RUDDER, SERVO_RUDDER, 
...
# 251 "./src/main/flight/servos.c" 3 4
_Bool 
# 251 "./src/main/flight/servos.c"
    loadCustomServoMixer(void)
{
    const mixerMode_e currentMixerMode = mixerConfig()->mixerMode;
    if (!(currentMixerMode == MIXER_CUSTOM_AIRPLANE || currentMixerMode == MIXER_CUSTOM_TRI || currentMixerMode == MIXER_CUSTOM)) {
        return 
# 255 "./src/main/flight/servos.c" 3 4
              0
# 255 "./src/main/flight/servos.c"
                   ;
    }
    ...
    return 
# 282 "./src/main/flight/servos.c" 3 4
          1
...
static void filterServos(void)
{
    if (servoConfig()->servo_lowpass_freq) {
        ...
        if (!servoFilterIsSet) {
            ...
            servoFilterIsSet = 
# 316 "./src/main/flight/servos.c" 3 4
                              1
# 316 "./src/main/flight/servos.c"
                                  ;
        }
...
# 336 "./src/main/flight/servos.c" 3 4
   _Bool 
# 336 "./src/main/flight/servos.c"
        zeroServoValue = 
# 336 "./src/main/flight/servos.c" 3 4
                         0
# 336 "./src/main/flight/servos.c"
    ...
    if ((currentMixerMode == MIXER_TRI || currentMixerMode == MIXER_CUSTOM_TRI) && !(armingFlags & (ARMED)) && !servoConfig()->tri_unarmed_servo) {
        zeroServoValue = 
# 343 "./src/main/flight/servos.c" 3 4
                        1
# 343 "./src/main/flight/servos.c"
                            ;
    }
...
# 563 "./src/main/flight/servos.c" 3 4
_Bool 
# 563 "./src/main/flight/servos.c"
    isServoOutputEnabled(void)
{
...
# 568 "./src/main/flight/servos.c" 3 4
_Bool 
# 568 "./src/main/flight/servos.c"
    isMixerUsingServos(void)
{
