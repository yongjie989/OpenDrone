...
# 162 "./src/main/drivers/io.c" 3 4
_Bool 
# 162 "./src/main/drivers/io.c"
    IORead(IO_t io)
{
    if (!io) {
        return 
# 165 "./src/main/drivers/io.c" 3 4
              0
# 165 "./src/main/drivers/io.c"
                   ;
    }
...
void IOWrite(IO_t io, 
# 174 "./src/main/drivers/io.c" 3 4
                     _Bool 
# 174 "./src/main/drivers/io.c"
                          hi)
{
    if (!io) {
        return;
...
static const uint16_t ioDefUsedMask[6] = { 0xffff,0xffff,((1 << (13))|(1 << (14))|(1 << (15))),0,0,((1 << (0))|(1 << (1))|(1 << (4))) };
...
IO_t IOGetByTag(ioTag_t tag)
{
    ...
    if (portIdx < 0 || portIdx >= 6) {
        return 
# 408 "./src/main/drivers/io.c" 3 4
              ((void *)0)
# 408 "./src/main/drivers/io.c"
                  ;
    }

    if (!(ioDefUsedMask[portIdx] & (1 << pinIdx))) {
        return 
# 412 "./src/main/drivers/io.c" 3 4
              ((void *)0)
# 412 "./src/main/drivers/io.c"
                  ;
    }
