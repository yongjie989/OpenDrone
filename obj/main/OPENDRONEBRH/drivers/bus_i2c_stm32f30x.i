...
# 79 "./src/main/platform.h" 2
# 22 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 24 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 26 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 29 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 31 "./src/main/drivers/bus_i2c_stm32f30x.c" 2
...
# 88 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
   _Bool 
# 88 "./src/main/drivers/bus_i2c_stm32f30x.c"
                   initialized;
    i2cState_t state;
    uint32_t timeout;
...
# 98 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
   _Bool 
# 98 "./src/main/drivers/bus_i2c_stm32f30x.c"
                               txnOk;
} i2cBusState_t;
...
static i2cDevice_t i2cHardwareMap[] = {
    { .dev = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005400)), .scl = ((((1) + 1) << 4) | (6)), .sda = ((((1) + 1) << 4) | (7)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00200000))>65535L) + (8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L)) >>8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L)) >>8*(((((uint32_t)0x00200000))*1L >>16*((((uint32_t)0x00200000))>65535L))>255))/2+1))))), .speed = I2C_SPEED_400KHZ },
    { .dev = ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)), .scl = ((((5) + 1) << 4) | (4)), .sda = ((((0) + 1) << 4) | (10)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00400000))>65535L) + (8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L)) >>8*(((((uint32_t)0x00400000))*1L >>16*((((uint32_t)0x00400000))>65535L))>255))/2+1))))), .speed = I2C_SPEED_400KHZ }
};
...
{
    (void)(i2cBusState);
# 121 "./src/main/drivers/bus_i2c_stm32f30x.c"
    i2cErrorCount++;
}
...
static void i2cStateMachine(i2cBusState_t * i2cBusState, const uint32_t currentTicks)
{
    ...
    switch (i2cBusState->state) {
        ...
        case I2C_STATE_STOPPING:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000020)) != RESET) {
        ...
        case I2C_STATE_STARTING_WAIT:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00008000)) == RESET) {
        ...
        case I2C_STATE_R_ADDR:
            ...
            I2C_TransferHandling(I2Cx, i2cBusState->addr, 1, ((uint32_t)0x00000000), ((uint32_t)0x00002000));
            i2cBusState->state = I2C_STATE_R_ADDR_WAIT;
            i2cBusState->timeout = currentTicks;
            __attribute__ ((fallthrough));

        case I2C_STATE_R_ADDR_WAIT:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000002)) != RESET) {
                i2cBusState->state = I2C_STATE_R_REGISTER;
            }
            else if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000010)) != RESET) {
        ...
        case I2C_STATE_R_REGISTER_WAIT:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000040)) != RESET) {
                if (i2cBusState->len == 0) {
                    I2C_TransferHandling(I2Cx, i2cBusState->addr, 0, ((uint32_t)0x02000000), ((uint32_t)0x00004000));
        ...
        case I2C_STATE_R_RESTARTING:
            I2C_TransferHandling(I2Cx, i2cBusState->addr, i2cBusState->len, ((uint32_t)0x02000000), (uint32_t)(((uint32_t)0x00002000) | ((uint32_t)0x00000400)));
            i2cBusState->state = I2C_STATE_R_TRANSFER;
            i2cBusState->timeout = currentTicks;
            __attribute__ ((fallthrough));

        case I2C_STATE_R_TRANSFER:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000004)) != RESET) {
                *i2cBusState->buf++ = I2C_ReceiveData(I2Cx);
                ...
                if (i2cBusState->len == 0) {
                    ...
                    i2cBusState->txnOk = 
# 223 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                                        1
# 223 "./src/main/drivers/bus_i2c_stm32f30x.c"
                                            ;
                    i2cBusState->state = I2C_STATE_STOPPING;
                }
        ...
        case I2C_STATE_W_ADDR:
            ...
            I2C_TransferHandling(I2Cx, i2cBusState->addr, 1, ((uint32_t)0x01000000), ((uint32_t)0x00002000));
        ...
        case I2C_STATE_W_REGISTER_WAIT:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000080)) != RESET) {
                if (i2cBusState->len == 0) {
                    I2C_TransferHandling(I2Cx, i2cBusState->addr, 0, ((uint32_t)0x02000000), ((uint32_t)0x00004000));
                    i2cBusState->state = I2C_STATE_STOPPING;
                }
        ...
        case I2C_STATE_W_RESTARTING:
            I2C_TransferHandling(I2Cx, i2cBusState->addr, i2cBusState->len, ((uint32_t)0x02000000), ((uint32_t)0x00000000));
        ...
        case I2C_STATE_W_TRANSFER:
            if (I2C_GetFlagStatus(I2Cx, ((uint32_t)0x00000002)) != RESET) {
                ...
                if (i2cBusState->len == 0) {
                    ...
                    i2cBusState->txnOk = 
# 290 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                                        1
# 290 "./src/main/drivers/bus_i2c_stm32f30x.c"
                                            ;
                    i2cBusState->state = I2C_STATE_STOPPING;
                }
        ...
        case I2C_STATE_NACK:
            I2C_TransferHandling(I2Cx, i2cBusState->addr, 0, ((uint32_t)0x02000000), ((uint32_t)0x00004000));
            I2C_ClearFlag(I2Cx, ((uint32_t)0x00000010));
            i2cBusState->state = I2C_STATE_STOPPING;
            break;
    }
}
...
uint32_t i2cTimeoutUserCallback(void)
{
    i2cErrorCount++;
    return 
# 320 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
          0
# 320 "./src/main/drivers/bus_i2c_stm32f30x.c"
               ;
}
...
void i2cInit(I2CDevice device)
{
    ...
    RCC_I2CCLKConfig(i2c->dev == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x00005800)) ? ((uint32_t)0x10000020) : ((uint32_t)0x00000010));

    IOInit(scl, OWNER_I2C, RESOURCE_I2C_SCL, (device + 1));
    IOConfigGPIOAF(scl, ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)), ((uint8_t)0x04));

    IOInit(sda, OWNER_I2C, RESOURCE_I2C_SDA, (device + 1));
    IOConfigGPIOAF(sda, ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_OD) << 4) | ((GPIO_PuPd_UP) << 5)), ((uint8_t)0x04));

    I2C_InitTypeDef i2cInit = {
        .I2C_Mode = ((uint32_t)0x00000000),
        .I2C_AnalogFilter = ((uint32_t)0x00000000),
        .I2C_DigitalFilter = 0x00,
        .I2C_OwnAddress1 = 0x00,
        .I2C_Ack = ((uint32_t)0x00000000),
        .I2C_AcknowledgedAddress = ((uint32_t)0x00000000),
    };
    ...
    switch (i2c->speed) {
        ...
        case I2C_SPEED_800KHZ:
            i2cInit.I2C_Timing = 0x00601C2E;
            break;

        case I2C_SPEED_100KHZ:
            i2cInit.I2C_Timing = 0x10C08DCF;
            break;

        case I2C_SPEED_200KHZ:
            i2cInit.I2C_Timing = 0xA010031A;
            break;
    }
...
# 375 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                                  1
# 375 "./src/main/drivers/bus_i2c_stm32f30x.c"
                                      ;
...
# 392 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
_Bool 
# 392 "./src/main/drivers/bus_i2c_stm32f30x.c"
    i2cWriteBuffer(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, const uint8_t * data)
{

    if (!busState[device].initialized)
        return 
# 396 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
              0
# 396 "./src/main/drivers/bus_i2c_stm32f30x.c"
                   ;
...
# 404 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                            0
# 404 "./src/main/drivers/bus_i2c_stm32f30x.c"
                                 ;
...
# 413 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
_Bool 
# 413 "./src/main/drivers/bus_i2c_stm32f30x.c"
...
# 419 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
_Bool 
# 419 "./src/main/drivers/bus_i2c_stm32f30x.c"
    i2cRead(I2CDevice device, uint8_t addr, uint8_t reg, uint8_t len, uint8_t* buf)
{

    if (!busState[device].initialized)
        return 
# 423 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
              0
# 423 "./src/main/drivers/bus_i2c_stm32f30x.c"
                   ;
    ...
    busState[device].txnOk = 
# 431 "./src/main/drivers/bus_i2c_stm32f30x.c" 3 4
                            0
# 431 "./src/main/drivers/bus_i2c_stm32f30x.c"
                                 ;
    busState[device].state = I2C_STATE_STARTING;
