...
# 167 "./src/main/flight/failsafe.c" 3 4
                              0
# 167 "./src/main/flight/failsafe.c"
                                   ;
...
# 172 "./src/main/flight/failsafe.c" 3 4
_Bool 
# 172 "./src/main/flight/failsafe.c"
    failsafeBypassNavigation(void)
{
...
# 193 "./src/main/flight/failsafe.c" 3 4
_Bool 
# 193 "./src/main/flight/failsafe.c"
    failsafeIsActive(void)
{
...
# 198 "./src/main/flight/failsafe.c" 3 4
_Bool 
# 198 "./src/main/flight/failsafe.c"
    failsafeShouldApplyControlInput(void)
{
...
# 203 "./src/main/flight/failsafe.c" 3 4
_Bool 
# 203 "./src/main/flight/failsafe.c"
    failsafeRequiresAngleMode(void)
{
...
# 208 "./src/main/flight/failsafe.c" 3 4
_Bool 
# 208 "./src/main/flight/failsafe.c"
    failsafeRequiresMotorStop(void)
{
    return failsafeState.active &&
...
{
    failsafeState.monitoring = 
# 217 "./src/main/flight/failsafe.c" 3 4
                              1
# 217 "./src/main/flight/failsafe.c"
                                  ;
}

static 
# 220 "./src/main/flight/failsafe.c" 3 4
      _Bool 
# 220 "./src/main/flight/failsafe.c"
...
{
    failsafeState.suspended = 
# 297 "./src/main/flight/failsafe.c" 3 4
                             1
# 297 "./src/main/flight/failsafe.c"
                                 ;
}
           ...
           failsafeCheckStickMotion(void)
{
    if (failsafeConfig()->failsafe_stick_motion_threshold > 0) {
        ...
        return 
# 340 "./src/main/flight/failsafe.c" 3 4
              1
# 340 "./src/main/flight/failsafe.c"
                  ;
    }
}
...
void failsafeUpdateState(void)
{
    ...
    const 
# 350 "./src/main/flight/failsafe.c" 3 4
         _Bool 
# 350 "./src/main/flight/failsafe.c"
              receivingRxDataAndNotFailsafeMode = failsafeIsReceivingRxData() && !IS_RC_MODE_ACTIVE(BOXFAILSAFE);
    const 
# 351 "./src/main/flight/failsafe.c" 3 4
         _Bool 
# 351 "./src/main/flight/failsafe.c"
...
# 360 "./src/main/flight/failsafe.c"
    ...
    do {
        reprocessState = 
# 363 "./src/main/flight/failsafe.c" 3 4
                        0
# 363 "./src/main/flight/failsafe.c"
                             ;
...
# 381 "./src/main/flight/failsafe.c"
            ...
            case FAILSAFE_RX_LOSS_DETECTED:
                ...
                reprocessState = 
# 436 "./src/main/flight/failsafe.c" 3 4
                                1
# 436 "./src/main/flight/failsafe.c"
                                    ;
                break;
            ...
            case FAILSAFE_RX_LOSS_IDLE:
                if (receivingRxDataAndNotFailsafeMode && sticksAreMoving) {
                    failsafeState.phase = FAILSAFE_RX_LOSS_RECOVERED;
                    reprocessState = 
# 443 "./src/main/flight/failsafe.c" 3 4
                                    1
# 443 "./src/main/flight/failsafe.c"
                                        ;
                }
                break;
            ...
            case FAILSAFE_RETURN_TO_HOME:
                if (receivingRxDataAndNotFailsafeMode && sticksAreMoving) {
                    ...
                    failsafeState.phase = FAILSAFE_RX_LOSS_RECOVERED;
                    reprocessState = 
# 452 "./src/main/flight/failsafe.c" 3 4
                                    1
# 452 "./src/main/flight/failsafe.c"
                                        ;
                }
                else {
                    if (armed) {
...
# 458 "./src/main/flight/failsafe.c" 3 4
                   _Bool 
# 458 "./src/main/flight/failsafe.c"
                        rthLanded = 
# 458 "./src/main/flight/failsafe.c" 3 4
                                    0
# 458 "./src/main/flight/failsafe.c"
                    ...
                    switch (getStateOfForcedRTH()) {
                        ...
                        case RTH_HAS_LANDED:
                            rthLanded = 
# 464 "./src/main/flight/failsafe.c" 3 4
                                       1
# 464 "./src/main/flight/failsafe.c"
                                           ;
                            break;
                        ...
                        default:
                            ...
                            failsafeActivate(FAILSAFE_LANDING);
                            reprocessState = 
# 472 "./src/main/flight/failsafe.c" 3 4
                                            1
# 472 "./src/main/flight/failsafe.c"
                                                ;
                            break;
                    }
                    if (rthLanded || !armed) {
                        ...
                        reprocessState = 
# 478 "./src/main/flight/failsafe.c" 3 4
                                        1
# 478 "./src/main/flight/failsafe.c"
                                            ;
                    }
                }
                break;
            ...
            case FAILSAFE_LANDING:
                if (receivingRxDataAndNotFailsafeMode && sticksAreMoving) {
                    failsafeState.phase = FAILSAFE_RX_LOSS_RECOVERED;
                    reprocessState = 
# 487 "./src/main/flight/failsafe.c" 3 4
                                    1
# 487 "./src/main/flight/failsafe.c"
                                        ;
                }
                if (armed) {
                    beeperMode = BEEPER_RX_LOST_LANDING;
                ...
                if (failsafeShouldHaveCausedLandingByNow() || !armed) {
                    ...
                    failsafeState.phase = FAILSAFE_LANDED;
                    reprocessState = 
# 495 "./src/main/flight/failsafe.c" 3 4
                                    1
# 495 "./src/main/flight/failsafe.c"
                                        ;
                }
                break;
            ...
            case FAILSAFE_LANDED:
                ...
                failsafeState.controlling = 
# 504 "./src/main/flight/failsafe.c" 3 4
                                           0
# 504 "./src/main/flight/failsafe.c"
                                                ;
                reprocessState = 
# 505 "./src/main/flight/failsafe.c" 3 4
                                1
# 505 "./src/main/flight/failsafe.c"
                                    ;
                break;
                ...
                if (receivingRxDataAndNotFailsafeMode) {
                    if (millis() > failsafeState.receivingRxDataPeriod) {
                        ...
                        if (!(!isUsingSticksForArming() && IS_RC_MODE_ACTIVE(BOXARM))) {
                            ...
                            failsafeState.phase = FAILSAFE_RX_LOSS_RECOVERED;
                            reprocessState = 
# 519 "./src/main/flight/failsafe.c" 3 4
                                            1
# 519 "./src/main/flight/failsafe.c"
                                                ;
                        }
                    }
                } else {
            ...
            case FAILSAFE_RX_LOSS_RECOVERED:
                ...
                failsafeState.phase = FAILSAFE_IDLE;
                failsafeState.active = 
# 533 "./src/main/flight/failsafe.c" 3 4
                                      0
# 533 "./src/main/flight/failsafe.c"
                                           ;
                failsafeState.controlling = 
# 534 "./src/main/flight/failsafe.c" 3 4
                                           0
# 534 "./src/main/flight/failsafe.c"
                                                ;
                disableFlightMode(FAILSAFE_MODE);
                reprocessState = 
