...
{
    void * retPointer = 
# 43 "./src/main/common/memory.c" 3 4
                       ((void *)0)
# 43 "./src/main/common/memory.c"
                           ;
    ...
    if ((dynHeapFreeWord + wantedWords) <= (1024) / sizeof(uint32_t)) {
        ...
        debugTracePrintf(
# 50 "./src/main/common/memory.c" 3 4
       0
# 50 "./src/main/common/memory.c"
       , "Memory allocated. Free memory = %d", memGetAvailableBytes());
    }
    else {

        debugTracePrintf(
# 54 "./src/main/common/memory.c" 3 4
       0
# 54 "./src/main/common/memory.c"
       , "Out of memory");
