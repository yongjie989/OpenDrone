...
# 10 "./src/main/drivers/timer_stm32f30x.c" 2
...
# 79 "./src/main/platform.h" 2
# 12 "./src/main/drivers/timer_stm32f30x.c" 2
...
# 14 "./src/main/drivers/timer_stm32f30x.c" 2
...
# 17 "./src/main/drivers/timer_stm32f30x.c" 2
...
# 18 "./src/main/drivers/timer_stm32f30x.c" 2
...
const timerDef_t timerDefinitions[10] = {
    ...
    { .TIMx = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000400)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000002))>65535L) + (8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/2+1))))), .irq = TIM3_IRQn },
    { .TIMx = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00000800)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000004))>65535L) + (8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L)) >>8*(((((uint32_t)0x00000004))*1L >>16*((((uint32_t)0x00000004))>65535L))>255))/2+1))))), .irq = TIM4_IRQn },
    ...
    { .TIMx = ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x00001400)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00000020))>65535L) + (8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L)) >>8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L)) >>8*(((((uint32_t)0x00000020))*1L >>16*((((uint32_t)0x00000020))>65535L))>255))/2+1))))), .irq = 0 },
    { .TIMx = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003400)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00002000))>65535L) + (8*(((((uint32_t)0x00002000))*1L >>16*((((uint32_t)0x00002000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00002000))*1L >>16*((((uint32_t)0x00002000))>65535L)) >>8*(((((uint32_t)0x00002000))*1L >>16*((((uint32_t)0x00002000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00002000))*1L >>16*((((uint32_t)0x00002000))>65535L)) >>8*(((((uint32_t)0x00002000))*1L >>16*((((uint32_t)0x00002000))>65535L))>255))/2+1))))), .irq = TIM8_CC_IRQn },
    { .TIMx = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00004000)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00010000))>65535L) + (8*(((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L)) >>8*(((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L)) >>8*(((((uint32_t)0x00010000))*1L >>16*((((uint32_t)0x00010000))>65535L))>255))/2+1))))), .irq = TIM1_BRK_TIM15_IRQn },
    { .TIMx = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00004400)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00020000))>65535L) + (8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L)) >>8*(((((uint32_t)0x00020000))*1L >>16*((((uint32_t)0x00020000))>65535L))>255))/2+1))))), .irq = TIM1_UP_TIM16_IRQn },
    { .TIMx = ((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00004800)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00040000))>65535L) + (8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/2+1))))), .irq = TIM1_TRG_COM_TIM17_IRQn },
};
