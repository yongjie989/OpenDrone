...
# 109 "./src/main/drivers/bus_spi.c"
static spiDevice_t spiHardwareMap[] = {




    { .dev = ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003000)), .nss = ((((1) + 1) << 4) | (9)), .sck = ((((1) + 1) << 4) | (3)), .miso = ((((1) + 1) << 4) | (4)), .mosi = ((((1) + 1) << 4) | (5)), .rcc = (((RCC_APB2) << 5) | (16*((((uint32_t)0x00001000))>65535L) + (8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L)) >>8*(((((uint32_t)0x00001000))*1L >>16*((((uint32_t)0x00001000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x05), 
# 114 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                     0
# 114 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                          , .divisorMap = spiDivisorMapFast },
    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003800)), .nss = ((((1) + 1) << 4) | (12)), .sck = ((((1) + 1) << 4) | (13)), .miso = ((((1) + 1) << 4) | (14)), .mosi = ((((1) + 1) << 4) | (15)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00004000))>65535L) + (8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L)) >>8*(((((uint32_t)0x00004000))*1L >>16*((((uint32_t)0x00004000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x05), 
# 115 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                     0
# 115 "./src/main/drivers/bus_spi.c"
                                                                                                                                                                                          , .divisorMap = spiDivisorMapSlow },


    { .dev = ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003C00)), .nss = ((((0) + 1) << 4) | (15)), .sck = ((((1) + 1) << 4) | (3)), .miso = ((((1) + 1) << 4) | (4)), .mosi = ((((1) + 1) << 4) | (5)), .rcc = (((RCC_APB1) << 5) | (16*((((uint32_t)0x00008000))>65535L) + (8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L)) >>8*(((((uint32_t)0x00008000))*1L >>16*((((uint32_t)0x00008000))>65535L))>255))/2+1))))), .af = ((uint8_t)0x06), 
# 118 "./src/main/drivers/bus_spi.c" 3 4
                                                                                                                                                                                     0
...
SPIDevice spiDeviceByInstance(SPI_TypeDef *instance)
{
    ...
    if (instance == ((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x00003C00)))
        return SPIDEV_3;
...
# 152 "./src/main/drivers/bus_spi.c"
    ...
    if (spi->leadingEdge) {
        IOConfigGPIOAF(IOGetByTag(spi->sck), ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_DOWN) << 5)), spi->af);
        IOConfigGPIOAF(IOGetByTag(spi->miso), ((GPIO_Mode_AF) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_UP) << 5)), spi->af);
    ...
    if (spi->nss) {
        IOConfigGPIOAF(IOGetByTag(spi->nss), ((GPIO_Mode_OUT) | ((GPIO_Speed_Level_3) << 2) | ((GPIO_OType_PP) << 4) | ((GPIO_PuPd_NOPULL) << 5)), spi->af);
    }
# 185 "./src/main/drivers/bus_spi.c"
...
# 226 "./src/main/drivers/bus_spi.c"
    ...
    case SPIDEV_2:
        ...
        spiInitDevice(device);
        return 
# 233 "./src/main/drivers/bus_spi.c" 3 4
              1
# 233 "./src/main/drivers/bus_spi.c"
                  ;
...
# 294 "./src/main/drivers/bus_spi.c" 3 4
_Bool 
# 294 "./src/main/drivers/bus_spi.c"
    spiIsBusBusy(SPI_TypeDef *instance)
{
    ...
    spiTransfer(SPI_TypeDef *instance, uint8_t *out, const uint8_t *in, int len)
{
    ...
    return 
# 334 "./src/main/drivers/bus_spi.c" 3 4
          1
# 334 "./src/main/drivers/bus_spi.c"
              ;
}
