...
void pidInit(void)
{
    ...
    pidGainsUpdateRequired = 
# 213 "./src/main/flight/pid.c" 3 4
                            0
# 213 "./src/main/flight/pid.c"
                                 ;
}
    ...
    pidInitFilters(void)
{
    ...
    if (refreshRate != 0 && pidProfile()->dterm_soft_notch_hz != 0){
        ...
        return 
# 226 "./src/main/flight/pid.c" 3 4
              1
# 226 "./src/main/flight/pid.c"
                  ;
    }
    return 
# 228 "./src/main/flight/pid.c" 3 4
          0
# 228 "./src/main/flight/pid.c"
               ;
}
...
{
    pidGainsUpdateRequired = 
# 324 "./src/main/flight/pid.c" 3 4
                            1
# 324 "./src/main/flight/pid.c"
                                ;
}
...
void updatePIDCoefficients(void)
{
    ...
    if ((stateFlags & (FIXED_WING)) && (currentControlRateProfile->throttle.fixedWingTauMs > 0)) {
        ...
        if (filteredThrottle != prevThrottle) {
            ...
            pidGainsUpdateRequired = 
# 336 "./src/main/flight/pid.c" 3 4
                                    1
# 336 "./src/main/flight/pid.c"
                                        ;
        }
    }
    else {
        if (rcCommand[THROTTLE] != prevThrottle) {
            ...
            pidGainsUpdateRequired = 
# 342 "./src/main/flight/pid.c" 3 4
                                    1
# 342 "./src/main/flight/pid.c"
                                        ;
        }
    }
    ...
    pidGainsUpdateRequired = 
# 380 "./src/main/flight/pid.c" 3 4
                            0
# 380 "./src/main/flight/pid.c"
                                 ;
}
