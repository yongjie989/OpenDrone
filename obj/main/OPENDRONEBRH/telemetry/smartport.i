...
# 126 "./src/main/telemetry/smartport.c" 3 4
                                          ((void *)0)
# 126 "./src/main/telemetry/smartport.c"
                                              ;
...
static 
# 152 "./src/main/telemetry/smartport.c" 3 4
      _Bool 
# 152 "./src/main/telemetry/smartport.c"
...
# 160 "./src/main/telemetry/smartport.c"
                                       ;
    static 
# 161 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 161 "./src/main/telemetry/smartport.c"
               byteStuffing = 
# 161 "./src/main/telemetry/smartport.c" 3 4
                              0
# 161 "./src/main/telemetry/smartport.c"
    ...
    if (c == FSSP_START_STOP) {
        *clearToSend = 
# 165 "./src/main/telemetry/smartport.c" 3 4
                      0
# 165 "./src/main/telemetry/smartport.c"
                           ;
        smartPortRxBytes = 0;
        awaitingSensorId = 
...
# 170 "./src/main/telemetry/smartport.c"
        ...
        return 
# 172 "./src/main/telemetry/smartport.c" 3 4
              ((void *)0)
# 172 "./src/main/telemetry/smartport.c"
                  ;
    }

    if (awaitingSensorId) {
        awaitingSensorId = 
# 176 "./src/main/telemetry/smartport.c" 3 4
                          0
# 176 "./src/main/telemetry/smartport.c"
                               ;
...
# 179 "./src/main/telemetry/smartport.c"
                              ;
            skipUntilStart = 
# 180 "./src/main/telemetry/smartport.c" 3 4
                            1
# 180 "./src/main/telemetry/smartport.c"
                                ;
        } else if (c == FSSP_SENSOR_ID2) {
            checksum = 0;
        } else {
            skipUntilStart = 
# 184 "./src/main/telemetry/smartport.c" 3 4
                            1
# 184 "./src/main/telemetry/smartport.c"
                                ;
        }
    } else {
        if (c == FSSP_DLE) {
            byteStuffing = 
# 188 "./src/main/telemetry/smartport.c" 3 4
                          1
# 188 "./src/main/telemetry/smartport.c"
                              ;

            return 
# 190 "./src/main/telemetry/smartport.c" 3 4
                  ((void *)0)
# 190 "./src/main/telemetry/smartport.c"
                      ;
...
# 193 "./src/main/telemetry/smartport.c"
        ...
        if (smartPortRxBytes < sizeof(smartPortPayload_t)) {
            ...
            if (!useChecksum && (smartPortRxBytes == sizeof(smartPortPayload_t))) {
                skipUntilStart = 
# 201 "./src/main/telemetry/smartport.c" 3 4
                                1
# 201 "./src/main/telemetry/smartport.c"
                                    ;
...
# 206 "./src/main/telemetry/smartport.c"
    ...
    return 
# 216 "./src/main/telemetry/smartport.c" 3 4
          ((void *)0)
# 216 "./src/main/telemetry/smartport.c"
              ;
}
...
# 241 "./src/main/telemetry/smartport.c" 3 4
                                        ((void *)0)
# 241 "./src/main/telemetry/smartport.c"
                                            , port);
}
...
# 259 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 259 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetry(void)
{
...
# 271 "./src/main/telemetry/smartport.c"
    ...
    return 
# 274 "./src/main/telemetry/smartport.c" 3 4
          0
# 274 "./src/main/telemetry/smartport.c"
               ;
}


# 277 "./src/main/telemetry/smartport.c" 3 4
_Bool 
# 277 "./src/main/telemetry/smartport.c"
    initSmartPortTelemetryExternal(smartPortWriteFrameFn *smartPortWriteFrameExternal)
{
    if (telemetryState == TELEMETRY_STATE_UNINITIALIZED) {
...
# 284 "./src/main/telemetry/smartport.c"
    ...
    return 
# 287 "./src/main/telemetry/smartport.c" 3 4
          0
# 287 "./src/main/telemetry/smartport.c"
               ;
}
...
static void freeSmartPortTelemetryPort(void)
{
    ...
    smartPortSerialPort = 
# 293 "./src/main/telemetry/smartport.c" 3 4
                         ((void *)0)
# 293 "./src/main/telemetry/smartport.c"
                             ;
}
...
# 308 "./src/main/telemetry/smartport.c" 3 4
       _Bool 
# 308 "./src/main/telemetry/smartport.c"
...
void processSmartPortTelemetry(smartPortPayload_t *payload, volatile 
# 328 "./src/main/telemetry/smartport.c" 3 4
                                                                    _Bool 
# 328 "./src/main/telemetry/smartport.c"
...
# 343 "./src/main/telemetry/smartport.c" 3 4
   _Bool 
# 343 "./src/main/telemetry/smartport.c"
        doRun = 
# 343 "./src/main/telemetry/smartport.c" 3 4
                1
# 343 "./src/main/telemetry/smartport.c"
    ...
    while (doRun && *clearToSend) {
        ...
        if (requestTimeout) {
            if (millis() >= *requestTimeout) {
                *clearToSend = 
# 348 "./src/main/telemetry/smartport.c" 3 4
                              0
# 348 "./src/main/telemetry/smartport.c"
                                   ;
            ...
            doRun = 
# 353 "./src/main/telemetry/smartport.c" 3 4
                   0
# 353 "./src/main/telemetry/smartport.c"
                        ;
        }
        ...
        if (smartPortMspReplyPending) {
            ...
            *clearToSend = 
# 359 "./src/main/telemetry/smartport.c" 3 4
                          0
# 359 "./src/main/telemetry/smartport.c"
                               ;
        ...
        switch (id) {
            case FSSP_DATAID_VFAS :
                if (isBatteryVoltageConfigured()) {
                    ...
                    *clearToSend = 
# 378 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 378 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_CURRENT :
                if (isAmperageConfigured()) {
                    ...
                    *clearToSend = 
# 384 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 384 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_ALTITUDE :
                if (sensors(SENSOR_BARO)) {
                    ...
                    *clearToSend = 
# 391 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 391 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_FUEL :
                if (telemetryConfig()->smartportFuelUnit == SMARTPORT_FUEL_UNIT_PERCENT) {
                    ...
                    *clearToSend = 
# 397 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 397 "./src/main/telemetry/smartport.c"
                                       ;
...
# 400 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_VARIO :
                if (sensors(SENSOR_BARO)) {
                    ...
                    *clearToSend = 
# 409 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 409 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
...
# 414 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_ACCX :
                ...
                *clearToSend = 
# 418 "./src/main/telemetry/smartport.c" 3 4
                              0
# 418 "./src/main/telemetry/smartport.c"
                                   ;
                break;
            case FSSP_DATAID_ACCY :
                smartPortSendPackage(id, lrintf(100 * acc.accADCf[Y]));
                *clearToSend = 
# 422 "./src/main/telemetry/smartport.c" 3 4
                              0
# 422 "./src/main/telemetry/smartport.c"
                                   ;
                break;
...
# 474 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_T2 :
                if (sensors(SENSOR_GPS)) {
                    ...
                    *clearToSend = 
# 497 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 497 "./src/main/telemetry/smartport.c"
                                       ;

                } else if (feature(FEATURE_GPS)) {
                    smartPortSendPackage(id, 0);
                    *clearToSend = 
# 501 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 501 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            ...
            case FSSP_DATAID_SPEED :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                    ...
                    *clearToSend = 
# 511 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 511 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_LATLONG :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                    ...
                    smartPortSendPackage(id, tmpui);
                    *clearToSend = 
# 531 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 531 "./src/main/telemetry/smartport.c"
                                       ;
                }
                break;
            case FSSP_DATAID_HOME_DIST :
                if (sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX))) {
                     ...
                     *clearToSend = 
# 537 "./src/main/telemetry/smartport.c" 3 4
                                   0
# 537 "./src/main/telemetry/smartport.c"
                                        ;
                }
                break;
...
# 550 "./src/main/telemetry/smartport.c"
            ...
            case FSSP_DATAID_ASPD :
                ...
                if (sensors(SENSOR_PITOT)) {
                    ...
                    *clearToSend = 
# 557 "./src/main/telemetry/smartport.c" 3 4
                                  0
# 557 "./src/main/telemetry/smartport.c"
                                       ;
                }
...
{
    static 
# 575 "./src/main/telemetry/smartport.c" 3 4
          _Bool 
# 575 "./src/main/telemetry/smartport.c"
               clearToSend = 
# 575 "./src/main/telemetry/smartport.c" 3 4
                             0
# 575 "./src/main/telemetry/smartport.c"
...
# 577 "./src/main/telemetry/smartport.c" 3 4
                                        ((void *)0)
# 577 "./src/main/telemetry/smartport.c"
                                            ;
...
# 584 "./src/main/telemetry/smartport.c" 3 4
                                                                                  1
# 584 "./src/main/telemetry/smartport.c"
                                                                                      );
            if (payload) {
