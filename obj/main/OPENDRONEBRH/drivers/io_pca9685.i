...
# 63 "./src/main/drivers/io_pca9685.c"
...
static 
# 102 "./src/main/drivers/io_pca9685.c" 3 4
      _Bool 
# 102 "./src/main/drivers/io_pca9685.c"
...
# 109 "./src/main/drivers/io_pca9685.c" 3 4
       _Bool 
# 109 "./src/main/drivers/io_pca9685.c"
            ack = busRead(busDev, 0x00, &sig);
        if (ack) {
            return 
# 111 "./src/main/drivers/io_pca9685.c" 3 4
                  1
# 111 "./src/main/drivers/io_pca9685.c"
                      ;
        }
    };

    return 
# 115 "./src/main/drivers/io_pca9685.c" 3 4
          0
# 115 "./src/main/drivers/io_pca9685.c"
               ;
}


# 118 "./src/main/drivers/io_pca9685.c" 3 4
_Bool 
# 118 "./src/main/drivers/io_pca9685.c"
...
# 121 "./src/main/drivers/io_pca9685.c"
        ...
        return 
# 122 "./src/main/drivers/io_pca9685.c" 3 4
              0
# 122 "./src/main/drivers/io_pca9685.c"
                   ;
    }
    ...
    if (!deviceDetect(busDev)) {
        ...
        return 
# 127 "./src/main/drivers/io_pca9685.c" 3 4
              0
# 127 "./src/main/drivers/io_pca9685.c"
                   ;
    }
    ...
    return 
# 143 "./src/main/drivers/io_pca9685.c" 3 4
          1
# 143 "./src/main/drivers/io_pca9685.c"
              ;
}
