...
# 27 "./src/main/drivers/system_stm32f30x.c" 2
...
# 74 "./src/main/drivers/system_stm32f30x.c" 3 4
_Bool 
# 74 "./src/main/drivers/system_stm32f30x.c"
    isMPUSoftReset(void)
{
    if (cachedRccCsrValue & ((uint32_t)0x10000000))
        return 
# 77 "./src/main/drivers/system_stm32f30x.c" 3 4
              1
# 77 "./src/main/drivers/system_stm32f30x.c"
                  ;
    else
        return 
# 79 "./src/main/drivers/system_stm32f30x.c" 3 4
              0
# 79 "./src/main/drivers/system_stm32f30x.c"
                   ;
}
