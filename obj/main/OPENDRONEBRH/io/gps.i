...
# 5 "/home/ethan/developer/opendrone/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/ctype.h" 2 3
...
# 6 "/home/ethan/developer/opendrone/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/ctype.h" 2 3
...
extern 
# 64 "./src/main/io/gps_private.h" 3 4
      _Bool 
# 64 "./src/main/io/gps_private.h"
           gpsHandleNMEA(void);
extern 
# 65 "./src/main/io/gps_private.h" 3 4
      _Bool 
# 65 "./src/main/io/gps_private.h"
           gpsHandleMTK(void);
extern 
# 66 "./src/main/io/gps_private.h" 3 4
      _Bool 
# 66 "./src/main/io/gps_private.h"
           gpsHandleUBLOX(void);
extern 
# 67 "./src/main/io/gps_private.h" 3 4
      _Bool 
# 67 "./src/main/io/gps_private.h"
           gpsHandleI2CNAV(void);
extern 
# 68 "./src/main/io/gps_private.h" 3 4
      _Bool 
# 68 "./src/main/io/gps_private.h"
           gpsDetectI2CNAV(void);
extern 
# 69 "./src/main/io/gps_private.h" 3 4
      _Bool 
# 69 "./src/main/io/gps_private.h"
           gpsHandleNAZA(void);
...
# 74 "./src/main/io/gps.c" 3 4
   _Bool 
# 74 "./src/main/io/gps.c"
                       hasCompass;
    
# 75 "./src/main/io/gps.c" 3 4
   _Bool 
# 75 "./src/main/io/gps.c"
        (*detect)(void);
    
# 76 "./src/main/io/gps.c" 3 4
   _Bool 
# 76 "./src/main/io/gps.c"
        (*read)(void);
...
static gpsProviderDescriptor_t gpsProviders[GPS_PROVIDER_COUNT] = {
    ...
    { GPS_TYPE_NA, 0, 
# 92 "./src/main/io/gps.c" 3 4
                     0
# 92 "./src/main/io/gps.c"
                          , 
# 92 "./src/main/io/gps.c" 3 4
                             ((void *)0)
# 92 "./src/main/io/gps.c"
...
# 120 "./src/main/io/gps.c"
    ...
    { GPS_TYPE_NA, 0, 
# 127 "./src/main/io/gps.c" 3 4
                     0
# 127 "./src/main/io/gps.c"
                          , 
# 127 "./src/main/io/gps.c" 3 4
                             ((void *)0)
# 127 "./src/main/io/gps.c"
...
# 134 "./src/main/io/gps.c" 3 4
0 
# 134 "./src/main/io/gps.c"
}
...
# 159 "./src/main/io/gps.c" 3 4
   _Bool 
# 159 "./src/main/io/gps.c"
        newDataReceived = 
# 159 "./src/main/io/gps.c" 3 4
                          0
# 159 "./src/main/io/gps.c"
...
# 255 "./src/main/io/gps.c" 3 4
                                                                                      ((void *)0)
# 255 "./src/main/io/gps.c"
                                                                                          , 
# 255 "./src/main/io/gps.c" 3 4
                                                                                            ((void *)0)
# 255 "./src/main/io/gps.c"
...
# 309 "./src/main/io/gps.c"
void gpsFinalizeChangeBaud(void)
{
    if ((gpsProviders[gpsState.gpsConfig->provider].type == GPS_TYPE_SERIAL) && (gpsState.gpsPort != 
# 311 "./src/main/io/gps.c" 3 4
                                                                                                    ((void *)0)
# 311 "./src/main/io/gps.c"
                                                                                                        )) {
...
void gpsThread(void)
{
    ...
    if ((gpsProviders[gpsState.gpsConfig->provider].type == GPS_TYPE_SERIAL) && (gpsState.gpsPort != 
# 346 "./src/main/io/gps.c" 3 4
                                                                                                    ((void *)0)
# 346 "./src/main/io/gps.c"
                                                                                                        )) {
...
# 456 "./src/main/io/gps.c"
    ...
    while (1) {
        if (serialRxBytesWaiting(gpsState.gpsPort)) {
            ledSet(0, 
# 462 "./src/main/io/gps.c" 3 4
           1
# 462 "./src/main/io/gps.c"
           );
...
# 486 "./src/main/io/gps.c" 3 4
_Bool 
# 486 "./src/main/io/gps.c"
    gpsMagInit(magDev_t *magDev)
{
    (void)(magDev);
    return 
# 489 "./src/main/io/gps.c" 3 4
          1
# 489 "./src/main/io/gps.c"
              ;
}


# 492 "./src/main/io/gps.c" 3 4
_Bool 
# 492 "./src/main/io/gps.c"
...
# 506 "./src/main/io/gps.c"
    ...
    mag->read = gpsMagRead;
    return 
# 511 "./src/main/io/gps.c" 3 4
          1
# 511 "./src/main/io/gps.c"
              ;
}


# 514 "./src/main/io/gps.c" 3 4
_Bool 
# 514 "./src/main/io/gps.c"
    isGPSHealthy(void)
{
    return 
# 516 "./src/main/io/gps.c" 3 4
          1
# 516 "./src/main/io/gps.c"
              ;
}
