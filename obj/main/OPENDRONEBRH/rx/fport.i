...
static volatile 
# 134 "./src/main/rx/fport.c" 3 4
               _Bool 
# 134 "./src/main/rx/fport.c"
                    clearToSend = 
# 134 "./src/main/rx/fport.c" 3 4
                                  0
# 134 "./src/main/rx/fport.c"
...
# 138 "./src/main/rx/fport.c" 3 4
                                       ((void *)0)
# 138 "./src/main/rx/fport.c"
                                           ;
static timeUs_t lastRcFrameReceivedMs = 0;

static serialPort_t *fportPort;
static 
# 142 "./src/main/rx/fport.c" 3 4
      _Bool 
# 142 "./src/main/rx/fport.c"
           telemetryEnabled = 
# 142 "./src/main/rx/fport.c" 3 4
                              0
# 142 "./src/main/rx/fport.c"
...
# 157 "./src/main/rx/fport.c"
    ...
    static 
# 159 "./src/main/rx/fport.c" 3 4
          _Bool 
# 159 "./src/main/rx/fport.c"
               telemetryFrame = 
# 159 "./src/main/rx/fport.c" 3 4
                                0
# 159 "./src/main/rx/fport.c"
...
# 182 "./src/main/rx/fport.c"
                ...
                telemetryFrame = 
# 184 "./src/main/rx/fport.c" 3 4
                                0
# 184 "./src/main/rx/fport.c"
                                     ;
            }
...
# 203 "./src/main/rx/fport.c"
                ...
                escapedCharacter = 
# 205 "./src/main/rx/fport.c" 3 4
                                  1
# 205 "./src/main/rx/fport.c"
                                      ;
...
static 
# 232 "./src/main/rx/fport.c" 3 4
      _Bool 
# 232 "./src/main/rx/fport.c"
            ...
            if (!checkChecksum(&rxBuffer[rxBufferReadIndex].data[0], bufferLength)) {
                ...
                case FPORT_FRAME_TYPE_CONTROL:
                    if (frameLength != (sizeof(uint8_t) + sizeof(fportControlData_t))) {
                        ...
                        setRSSI(scaleRange(constrain(frame->data.controlData.rssi, 0, 100), 0, 100, 0, 1024), RSSI_SOURCE_RX_PROTOCOL, 
# 269 "./src/main/rx/fport.c" 3 4
                                                                                                                                      0
# 269 "./src/main/rx/fport.c"
                                                                                                                                           );
                ...
                case FPORT_FRAME_TYPE_TELEMETRY_REQUEST:
                    if (frameLength != (sizeof(uint8_t) + sizeof(smartPortPayload_t))) {
                        ...
                        case FPORT_FRAME_ID_DATA:
                            hasTelemetryRequest = 
# 287 "./src/main/rx/fport.c" 3 4
                                                 1
# 287 "./src/main/rx/fport.c"
                                                     ;
    ...
    if ((mspPayload || hasTelemetryRequest) && cmpTimeUs(micros(), lastTelemetryFrameReceivedUs) >= 500) {
        hasTelemetryRequest = 
# 317 "./src/main/rx/fport.c" 3 4
                             0
# 317 "./src/main/rx/fport.c"
                                  ;
...
static 
# 330 "./src/main/rx/fport.c" 3 4
      _Bool 
# 330 "./src/main/rx/fport.c"
           fportProcessFrame(const rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (cmpTimeUs(currentTimeUs, lastTelemetryFrameReceivedUs) > 2000) {
       clearToSend = 
# 337 "./src/main/rx/fport.c" 3 4
                    0
# 337 "./src/main/rx/fport.c"
                         ;
    }
...
# 348 "./src/main/rx/fport.c"
    ...
    mspPayload = 
# 352 "./src/main/rx/fport.c" 3 4
                ((void *)0)
# 352 "./src/main/rx/fport.c"
                    ;


    return 
# 355 "./src/main/rx/fport.c" 3 4
          1
# 355 "./src/main/rx/fport.c"
              ;
}


# 358 "./src/main/rx/fport.c" 3 4
_Bool 
# 358 "./src/main/rx/fport.c"
    fportRxInit(const rxConfig_t *rxConfig, rxRuntimeConfig_t *rxRuntimeConfig)
{
    ...
    if (!portConfig) {
        return 
# 372 "./src/main/rx/fport.c" 3 4
              0
# 372 "./src/main/rx/fport.c"
                   ;
    }
...
# 378 "./src/main/rx/fport.c" 3 4
       ((void *)0)
# 378 "./src/main/rx/fport.c"
           ,
        115200,
        MODE_RXTX,
    ...
    return fportPort != 
# 390 "./src/main/rx/fport.c" 3 4
                       ((void *)0)
# 390 "./src/main/rx/fport.c"
                           ;
}
