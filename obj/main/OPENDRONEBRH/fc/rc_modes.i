...
# 49 "./src/main/fc/rc_modes.c" 3 4
_Bool 
# 49 "./src/main/fc/rc_modes.c"
    isUsingSticksForArming(void)
{
    ...
    isModeActivationConditionPresent(boxId_e modeId)
{
    for (int index = 0; index < 20; index++) {
        if (modeActivationConditions(index)->modeId == modeId && ((&modeActivationConditions(index)->range)->startStep < (&modeActivationConditions(index)->range)->endStep)) {
            return 
# 81 "./src/main/fc/rc_modes.c" 3 4
                  1
# 81 "./src/main/fc/rc_modes.c"
                      ;
        }
    }
    ...
    isRangeActive(uint8_t auxChannelIndex, const channelRange_t *range)
{
    if (!((range)->startStep < (range)->endStep)) {
        return 
# 91 "./src/main/fc/rc_modes.c" 3 4
              0
# 91 "./src/main/fc/rc_modes.c"
                   ;
    }
