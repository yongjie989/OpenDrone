...
static 
# 61 "./src/main/flight/mixer.c" 3 4
      _Bool 
# 61 "./src/main/flight/mixer.c"
           motorLimitReached = 
# 61 "./src/main/flight/mixer.c" 3 4
                               0
# 61 "./src/main/flight/mixer.c"
...
static const mixer_t mixerTable[] = {
    ...
    { .mixerMode=MIXER_TRI, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=3, .useServos=
# 234 "./src/main/flight/mixer.c" 3 4
   1
# 234 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 234 "./src/main/flight/mixer.c" 3 4
   0
# 234 "./src/main/flight/mixer.c"
   , .motor=mixerTricopter },
    { .mixerMode=MIXER_CUSTOM_TRI, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=3, .useServos=
# 235 "./src/main/flight/mixer.c" 3 4
   0
# 235 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 235 "./src/main/flight/mixer.c" 3 4
   0
# 235 "./src/main/flight/mixer.c"
...
# 235 "./src/main/flight/mixer.c"
    ...
    { .mixerMode=MIXER_QUADP, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=4, .useServos=
# 237 "./src/main/flight/mixer.c" 3 4
   0
# 237 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 237 "./src/main/flight/mixer.c" 3 4
   0
# 237 "./src/main/flight/mixer.c"
   , .motor=mixerQuadP },
    { .mixerMode=MIXER_QUADX, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=4, .useServos=
# 238 "./src/main/flight/mixer.c" 3 4
   0
# 238 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 238 "./src/main/flight/mixer.c" 3 4
   0
# 238 "./src/main/flight/mixer.c"
   , .motor=mixerQuadX },
    ...
    { .mixerMode=MIXER_HEX6X, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=6, .useServos=
# 241 "./src/main/flight/mixer.c" 3 4
   0
...
# 241 "./src/main/flight/mixer.c"
   , .motor=mixerHex6X },
    ...
    { .mixerMode=MIXER_CUSTOM, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=0, .useServos=
# 244 "./src/main/flight/mixer.c" 3 4
   0
# 244 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 244 "./src/main/flight/mixer.c" 3 4
   0
# 244 "./src/main/flight/mixer.c"
...
# 244 "./src/main/flight/mixer.c"
    ...
    { .mixerMode=MIXER_FLYING_WING, .flyingPlatformType=PLATFORM_AIRPLANE, .motorCount=2, .useServos=
# 249 "./src/main/flight/mixer.c" 3 4
   1
# 249 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 249 "./src/main/flight/mixer.c" 3 4
   0
# 249 "./src/main/flight/mixer.c"
   , .motor=mixerDualProp },
    { .mixerMode=MIXER_AIRPLANE, .flyingPlatformType=PLATFORM_AIRPLANE, .motorCount=2, .useServos=
# 250 "./src/main/flight/mixer.c" 3 4
   1
# 250 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 250 "./src/main/flight/mixer.c" 3 4
   1
# 250 "./src/main/flight/mixer.c"
   , .motor=mixerDualProp },
    { .mixerMode=MIXER_CUSTOM_AIRPLANE, .flyingPlatformType=PLATFORM_AIRPLANE, .motorCount=2, .useServos=
# 251 "./src/main/flight/mixer.c" 3 4
   1
# 251 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 251 "./src/main/flight/mixer.c" 3 4
   1
# 251 "./src/main/flight/mixer.c"
...
# 261 "./src/main/flight/mixer.c"
    { .mixerMode=MIXER_Y4, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=4, .useServos=
# 261 "./src/main/flight/mixer.c" 3 4
   0
# 261 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 261 "./src/main/flight/mixer.c" 3 4
...
# 261 "./src/main/flight/mixer.c"
   , .motor=mixerY4 },
    { .mixerMode=MIXER_ATAIL4, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=4, .useServos=
# 262 "./src/main/flight/mixer.c" 3 4
   0
# 262 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 262 "./src/main/flight/mixer.c" 3 4
   0
# 262 "./src/main/flight/mixer.c"
   , .motor=mixerAtail4 },
    { .mixerMode=MIXER_VTAIL4, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=4, .useServos=
# 263 "./src/main/flight/mixer.c" 3 4
   0
# 263 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 263 "./src/main/flight/mixer.c" 3 4
   0
# 263 "./src/main/flight/mixer.c"
   , .motor=mixerVtail4 },
    ...
    { .mixerMode=MIXER_Y6, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=6, .useServos=
# 266 "./src/main/flight/mixer.c" 3 4
   0
# 266 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 266 "./src/main/flight/mixer.c" 3 4
   0
# 266 "./src/main/flight/mixer.c"
   , .motor=mixerY6 },
    { .mixerMode=MIXER_HEX6, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=6, .useServos=
# 267 "./src/main/flight/mixer.c" 3 4
   0
# 267 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 267 "./src/main/flight/mixer.c" 3 4
   0
# 267 "./src/main/flight/mixer.c"
   , .motor=mixerHex6P },
    { .mixerMode=MIXER_HEX6H, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=6, .useServos=
# 268 "./src/main/flight/mixer.c" 3 4
   0
...
# 268 "./src/main/flight/mixer.c"
   , .motor=mixerHex6H },
    ...
    { .mixerMode=MIXER_OCTOX8, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=8, .useServos=
# 272 "./src/main/flight/mixer.c" 3 4
   0
# 272 "./src/main/flight/mixer.c"
   , .hasFlaps=
# 272 "./src/main/flight/mixer.c" 3 4
   0
# 272 "./src/main/flight/mixer.c"
   , .motor=mixerOctoX8 },
    { .mixerMode=MIXER_OCTOFLATP, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=8, .useServos=
...
# 273 "./src/main/flight/mixer.c" 3 4
   0
# 273 "./src/main/flight/mixer.c"
   , .motor=mixerOctoFlatP },
    { .mixerMode=MIXER_OCTOFLATX, .flyingPlatformType=PLATFORM_MULTIROTOR, .motorCount=8, .useServos=
...
void mixerLoadMix(int index, motorMixer_t *customMixers)
{
    ...
    if (mixer->motor != 
# 415 "./src/main/flight/mixer.c" 3 4
                       ((void *)0)
# 415 "./src/main/flight/mixer.c"
                           ) {
...
#define THROTTLE_CLIPPING_FACTOR 0.33f
    if (rpyMixRange > throttleRange) {
        motorLimitReached = 
# 531 "./src/main/flight/mixer.c" 3 4
                           1
# 531 "./src/main/flight/mixer.c"
                               ;
        ...
        motorLimitReached = 
# 542 "./src/main/flight/mixer.c" 3 4
                           0
# 542 "./src/main/flight/mixer.c"
                                ;
...
# 567 "./src/main/flight/mixer.c" 3 4
               _Bool 
# 567 "./src/main/flight/mixer.c"
                    failsafeMotorStop = failsafeRequiresMotorStop();
                
# 568 "./src/main/flight/mixer.c" 3 4
               _Bool 
# 568 "./src/main/flight/mixer.c"
                    navMotorStop = !failsafeIsActive() && (stateFlags & (NAV_MOTOR_STOP_OR_IDLE));
                
# 569 "./src/main/flight/mixer.c" 3 4
               _Bool 
# 569 "./src/main/flight/mixer.c"
                    userMotorStop = !navigationIsFlyingAutonomousMode() && !failsafeIsActive() && (rcData[THROTTLE] < rxConfig()->mincheck);
