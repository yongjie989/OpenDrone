...
# 155 "./src/main/drivers/pwm_output.c" 3 4
                                                                                                                             _Bool 
# 155 "./src/main/drivers/pwm_output.c"
                                                                                                                                  enableOutput)
{
    if (allocatedOutputPortCount >= 10) {
        debugTracePrintf(
# 158 "./src/main/drivers/pwm_output.c" 3 4
       0
# 158 "./src/main/drivers/pwm_output.c"
       , "Attempt to allocate PWM output beyond MAX_PWM_OUTPUT_PORTS");
        return 
# 159 "./src/main/drivers/pwm_output.c" 3 4
              ((void *)0)
# 159 "./src/main/drivers/pwm_output.c"
                  ;
    }
...
{
    pwmMotorsEnabled = 
# 229 "./src/main/drivers/pwm_output.c" 3 4
                      0
# 229 "./src/main/drivers/pwm_output.c"
                           ;
}
...
{
    pwmMotorsEnabled = 
# 234 "./src/main/drivers/pwm_output.c" 3 4
                      1
# 234 "./src/main/drivers/pwm_output.c"
                          ;
}


# 237 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 237 "./src/main/drivers/pwm_output.c"
...
# 242 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 242 "./src/main/drivers/pwm_output.c"
                                                                                                                                                            ...
                                                                                                                                                            enableOutput)
{
    ...
    if (port) {
        ...
        return 
# 287 "./src/main/drivers/pwm_output.c" 3 4
              1
# 287 "./src/main/drivers/pwm_output.c"
                  ;
    }

    return 
# 290 "./src/main/drivers/pwm_output.c" 3 4
          0
# 290 "./src/main/drivers/pwm_output.c"
               ;
}



# 294 "./src/main/drivers/pwm_output.c" 3 4
_Bool 
# 294 "./src/main/drivers/pwm_output.c"
...
# 300 "./src/main/drivers/pwm_output.c"
    ...
    return 
# 303 "./src/main/drivers/pwm_output.c" 3 4
          0
# 303 "./src/main/drivers/pwm_output.c"
               ;
}
