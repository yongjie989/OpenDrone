...
static __attribute__ ((section(".fastram_bss"), aligned(4))) float rMat[3][3];
...
static void imuCalculateEstimatedAttitude(float dT)
{
    ...
    const 
# 455 "./src/main/flight/imu.c" 3 4
         _Bool 
# 455 "./src/main/flight/imu.c"
              canUseMAG = 
# 455 "./src/main/flight/imu.c" 3 4
                          0
# 455 "./src/main/flight/imu.c"
...
# 466 "./src/main/flight/imu.c"
            canUseCOG = sensors(SENSOR_GPS) && (stateFlags & (GPS_FIX)) && gpsSol.numSat >= 6 && gpsSol.groundSpeed >= 300;
...
# 581 "./src/main/flight/imu.c" 3 4
_Bool 
# 581 "./src/main/flight/imu.c"
    isImuReady(void)
{
...
# 586 "./src/main/flight/imu.c" 3 4
_Bool 
# 586 "./src/main/flight/imu.c"
    isImuHeadingValid(void)
{
