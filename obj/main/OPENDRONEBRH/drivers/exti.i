...
# 153 "./src/main/drivers/exti.c"
    ...
    extiChannelRec_t *rec = &extiChannelRecs[chIdx];
    rec->handler = 
# 164 "./src/main/drivers/exti.c" 3 4
                  ((void *)0)
# 164 "./src/main/drivers/exti.c"
                      ;
}

void EXTIEnable(IO_t io, 
# 167 "./src/main/drivers/exti.c" 3 4
                        _Bool 
# 167 "./src/main/drivers/exti.c"
                             enable)
{
# 178 "./src/main/drivers/exti.c"
