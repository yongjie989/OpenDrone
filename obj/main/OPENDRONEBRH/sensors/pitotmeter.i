...
static void performPitotCalibrationCycle(void)
{
    ...
    if (( __extension__ ({ __typeof__(pitotPressureZeroError) _abs0 = (pitotPressureZeroError); _abs0 < 0 ? -_abs0 : _abs0; })) < (101325.0f * 0.00001f)) {
        if ((millis() - pitotCalibrationTimeout) > 250) {
            pitotCalibrationFinished = 
# 233 "./src/main/sensors/pitotmeter.c" 3 4
                                      1
# 233 "./src/main/sensors/pitotmeter.c"
                                          ;
        }
    }
    else {
...
# 252 "./src/main/sensors/pitotmeter.c"
        ...
        {if (debugMode == (DEBUG_PITOT)) {debug[(2)] = (indicatedAirspeed_tmp);}};
        {if (debugMode == (DEBUG_PITOT)) {debug[(3)] = (indicatedAirspeed);}};
...
# 266 "./src/main/sensors/pitotmeter.c" 3 4
_Bool 
# 266 "./src/main/sensors/pitotmeter.c"
    pitotIsHealthy(void)
{
    return 
# 268 "./src/main/sensors/pitotmeter.c" 3 4
          1
# 268 "./src/main/sensors/pitotmeter.c"
              ;
}
