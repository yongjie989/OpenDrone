...
# 35 "/home/ethan/developer/opendrone/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/stdlib.h" 3
typedef struct
{
  int quot;
  int rem;
...
# 141 "./src/main/drivers/gpio.h" 3 4
                                       _Bool 
# 141 "./src/main/drivers/gpio.h"
                                            enable);
...
# 26 "./src/main/drivers/inverter.h" 3 4
                                          _Bool 
# 26 "./src/main/drivers/inverter.h"
                                               on);
...
typedef struct {
    serialPort_t port;
# 67 "./src/main/drivers/serial_uart.h"
...
int fscanf (FILE *restrict, const char *restrict, ...) __attribute__ ((__format__ (__scanf__, 2, 3)))
                                                           ;
int 
# 200 "/home/ethan/developer/opendrone/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/stdio.h"
   tfp_printf 
# 200 "/home/ethan/developer/opendrone/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/stdio.h" 3
   (const char *restrict, ...) __attribute__ ((__format__ (__printf__, 1, 2)))
                                                            ;
...
int 
# 244 "/home/ethan/developer/opendrone/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/stdio.h"
   tfp_sprintf 
# 244 "/home/ethan/developer/opendrone/tools/gcc-arm-none-eabi-7-2017-q4-major/arm-none-eabi/include/stdio.h" 3
   (char *restrict, const char *restrict, ...) __attribute__ ((__format__ (__printf__, 2, 3)))
                                                            ;
...
# 27 "./src/main/io/vtx_smartaudio.h"
...
extern 
# 77 "./src/main/io/vtx_smartaudio.h" 3 4
      _Bool 
# 77 "./src/main/io/vtx_smartaudio.h"
           saDeferred;
...
# 86 "./src/main/io/vtx_smartaudio.h" 3 4
_Bool 
# 86 "./src/main/io/vtx_smartaudio.h"
    vtxSmartAudioInit(void);
# 97 "./src/main/io/vtx_smartaudio.h"
#define dprintf(x) 
...
# 158 "./src/main/fc/fc_init.c"
    ...
    for (uint8_t i = 0; i < 10; i++) {
        ...
        if (!(getPreferredBeeperOffMask() & (1 << (BEEPER_SYSTEM_INIT - 1))))
            systemBeep(
# 164 "./src/main/fc/fc_init.c" 3 4
           1
# 164 "./src/main/fc/fc_init.c"
           );
        delay(25);
        systemBeep(
# 166 "./src/main/fc/fc_init.c" 3 4
       0
# 166 "./src/main/fc/fc_init.c"
       );
    }
    ledSet(0, 
# 168 "./src/main/fc/fc_init.c" 3 4
   0
# 168 "./src/main/fc/fc_init.c"
   );
    do {} while (0);
}
...
# 197 "./src/main/fc/fc_init.c"
    ...
    ledInit(
# 221 "./src/main/fc/fc_init.c" 3 4
           0
# 221 "./src/main/fc/fc_init.c"
                );
...
# 337 "./src/main/fc/fc_init.c" 3 4
                               0
# 337 "./src/main/fc/fc_init.c"
                                    ;
...
# 354 "./src/main/fc/fc_init.c" 3 4
                                    0
# 354 "./src/main/fc/fc_init.c"
                                         ;
        pwm_params.useChannelForwarding = 
# 355 "./src/main/fc/fc_init.c" 3 4
                                         0
# 355 "./src/main/fc/fc_init.c"
                                              ;
    }
...
# 365 "./src/main/fc/fc_init.c"
    ...
    beeperDevConfig_t beeperDevConfig = {
        ...
        .isOD = 
# 374 "./src/main/fc/fc_init.c" 3 4
               0
# 374 "./src/main/fc/fc_init.c"
                    ,
        .isInverted = 
# 375 "./src/main/fc/fc_init.c" 3 4
                     1
...
# 390 "./src/main/fc/fc_init.c"
    beeperInit(&beeperDevConfig);
# 401 "./src/main/fc/fc_init.c"
    busInit();
    ...
    spiInit(SPIDEV_2);
# 449 "./src/main/fc/fc_init.c"
            i2cInit(I2CDEV_1);
# 483 "./src/main/fc/fc_init.c"
    ...
    if (!isMPUSoftReset()) {
        ...
        do {} while (0);
        ledSet(0, 
# 516 "./src/main/fc/fc_init.c" 3 4
       0
# 516 "./src/main/fc/fc_init.c"
       );
        ...
        ledSet(0, 
# 524 "./src/main/fc/fc_init.c" 3 4
       0
# 524 "./src/main/fc/fc_init.c"
       );
        do {} while (0);
    }
...
# 700 "./src/main/fc/fc_init.c"
    ...
    latchActiveFeatures();
    motorControlEnable = 
# 722 "./src/main/fc/fc_init.c" 3 4
                        1
# 722 "./src/main/fc/fc_init.c"
                            ;
    fcTasksInit();
