...
static void updateAltitudeThrottleController_MC(timeDelta_t deltaMicros)
{
    ...
    posControl.rcAdjustment[THROTTLE] = navPidApply2(&posControl.pids.vel[Z], posControl.desiredState.vel.z, posControl.actualState.vel.z, ((deltaMicros) * 1e-6f), thrAdjustmentMin, thrAdjustmentMax, 0);
...
# 102 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 102 "./src/main/navigation/navigation_multicopter.c"
    adjustMulticopterAltitudeFromRCInput(void)
{
    ...
    if (rcThrottleAdjustment) {
        ...
        return 
# 121 "./src/main/navigation/navigation_multicopter.c" 3 4
              1
# 121 "./src/main/navigation/navigation_multicopter.c"
                  ;
    }
    else {
        ...
        return 
# 129 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 129 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
}
...
void setupMulticopterAltitudeController(void)
{
    ...
    if (throttleStatus == THROTTLE_LOW) {
        prepareForTakeoffOnReset = 
# 157 "./src/main/navigation/navigation_multicopter.c" 3 4
                                  1
# 157 "./src/main/navigation/navigation_multicopter.c"
                                      ;
    }
}
...
void resetMulticopterAltitudeController(void)
{
    ...
    if (prepareForTakeoffOnReset) {
        ...
        prepareForTakeoffOnReset = 
# 173 "./src/main/navigation/navigation_multicopter.c" 3 4
                                  0
# 173 "./src/main/navigation/navigation_multicopter.c"
                                       ;
    }
    else {
        posControl.desiredState.vel.z = posControl.actualState.vel.z;
...
# 226 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 226 "./src/main/navigation/navigation_multicopter.c"
    adjustMulticopterHeadingFromRCInput(void)
{
    if (( __extension__ ({ __typeof__(rcCommand[YAW]) _abs2 = (rcCommand[YAW]); _abs2 < 0 ? -_abs2 : _abs2; })) > rcControlsConfig()->pos_hold_deadband) {
        ...
        return 
# 232 "./src/main/navigation/navigation_multicopter.c" 3 4
              1
# 232 "./src/main/navigation/navigation_multicopter.c"
                  ;
    }
    else {
        return 
# 235 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 235 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
}
    ...
    adjustMulticopterPositionFromRCInput(void)
{
    ...
    if (rcPitchAdjustment || rcRollAdjustment) {
        ...
        return 
# 277 "./src/main/navigation/navigation_multicopter.c" 3 4
              1
# 277 "./src/main/navigation/navigation_multicopter.c"
                  ;
    }
    else {
        ...
        return 
# 287 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 287 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
}
...
static void updatePositionAccelController_MC(timeDelta_t deltaMicros, float maxAccelLimit)
{
    ...
    const float newAccelX = navPidApply2(&posControl.pids.vel[X], posControl.desiredState.vel.x, posControl.actualState.vel.x, ((deltaMicros) * 1e-6f), accelLimitXMin, accelLimitXMax, 0);
    const float newAccelY = navPidApply2(&posControl.pids.vel[Y], posControl.desiredState.vel.y, posControl.actualState.vel.y, ((deltaMicros) * 1e-6f), accelLimitYMin, accelLimitYMax, 0);
...
# 410 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 410 "./src/main/navigation/navigation_multicopter.c"
    ...
    if ((posControl.flags.estPosStatue >= EST_USABLE)) {
        ...
        bypassPositionController = 
# 450 "./src/main/navigation/navigation_multicopter.c" 3 4
                                  1
# 450 "./src/main/navigation/navigation_multicopter.c"
                                      ;
    }
...
# 477 "./src/main/navigation/navigation_multicopter.c" 3 4
_Bool 
# 477 "./src/main/navigation/navigation_multicopter.c"
    isMulticopterLandingDetected(void)
{
...
# 487 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 487 "./src/main/navigation/navigation_multicopter.c"
        verticalMovement = fabsf(posControl.actualState.vel.z) > 25.0f;


    
# 490 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 490 "./src/main/navigation/navigation_multicopter.c"
...
# 496 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 496 "./src/main/navigation/navigation_multicopter.c"
        isAtMinimalThrust = 
# 496 "./src/main/navigation/navigation_multicopter.c" 3 4
                            0
# 496 "./src/main/navigation/navigation_multicopter.c"
...
# 503 "./src/main/navigation/navigation_multicopter.c" 3 4
   _Bool 
# 503 "./src/main/navigation/navigation_multicopter.c"
    ...
    if (!possibleLandingDetected) {
        ...
        return 
# 519 "./src/main/navigation/navigation_multicopter.c" 3 4
              0
# 519 "./src/main/navigation/navigation_multicopter.c"
                   ;
    }
    else {
        return ((currentTimeUs - landingTimer) > (navConfig()->mc.auto_disarm_delay * 1000)) ? 
# 522 "./src/main/navigation/navigation_multicopter.c" 3 4
                                                                                              1 
# 522 "./src/main/navigation/navigation_multicopter.c"
                                                                                                   : 
# 522 "./src/main/navigation/navigation_multicopter.c" 3 4
                                                                                                     0
# 522 "./src/main/navigation/navigation_multicopter.c"
