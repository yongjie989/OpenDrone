...
# 79 "./src/main/platform.h" 2
# 30 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 32 "./src/main/drivers/serial_uart_stm32f30x.c" 2
...
# 87 "./src/main/drivers/serial_uart_stm32f30x.c"
...
# 102 "./src/main/drivers/serial_uart_stm32f30x.c"
static void handleUsartTxDma(dmaChannelDescriptor_t* descriptor)
{
    ...
    if (s->port.txBufferHead != s->port.txBufferTail)
        ...
        s->txDMAEmpty = 
# 111 "./src/main/drivers/serial_uart_stm32f30x.c" 3 4
                       1
# 111 "./src/main/drivers/serial_uart_stm32f30x.c"
                           ;
}
...
uartPort_t *serialUART1(uint32_t baudRate, portMode_t mode, portOptions_t options)
{
    ...
    RCC_ClockCmd((((RCC_AHB) << 5) | (16*((((uint32_t)0x00000001))>65535L) + (8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/2+1))))), ENABLE);

    serialUARTInit(IOGetByTag(((((0) + 1) << 4) | (9))), IOGetByTag(((((0) + 1) << 4) | (10))), mode, options, ((uint8_t)0x07), 1);

    dmaSetHandler(DMA1_CH4_HANDLER, handleUsartTxDma, (((((1)<<(4-(7-(((uint32_t)0x500)>>8))))|((1)&(0x0f>>(7-(((uint32_t)0x500)>>8)))))<<4)&0xf0), (uint32_t)&uartPort1);
...
# 217 "./src/main/drivers/serial_uart_stm32f30x.c"
    ...
    serialUARTInit(IOGetByTag(((((0) + 1) << 4) | (14))), IOGetByTag(((((0) + 1) << 4) | (15))), mode, options, ((uint8_t)0x07), 2);
...
# 272 "./src/main/drivers/serial_uart_stm32f30x.c"
    RCC_ClockCmd((((RCC_APB1) << 5) | (16*((((uint32_t)0x00040000))>65535L) + (8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L)) >>8*(((((uint32_t)0x00040000))*1L >>16*((((uint32_t)0x00040000))>65535L))>255))/2+1))))), ENABLE);





    serialUARTInit(IOGetByTag(((((1) + 1) << 4) | (10))), IOGetByTag(((((1) + 1) << 4) | (11))), mode, options, ((uint8_t)0x07), 3);
...
# 367 "./src/main/drivers/serial_uart_stm32f30x.c"
