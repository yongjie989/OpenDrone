...
# 72 "./src/main/drivers/adc.c" 3 4
_Bool 
# 72 "./src/main/drivers/adc.c"
    adcIsFunctionAssigned(uint8_t function)
{
...
static 
# 91 "./src/main/drivers/adc.c" 3 4
      _Bool 
# 91 "./src/main/drivers/adc.c"
           isChannelInUse(int channel)
{
    for (int i = 0; i < ADC_FUNCTION_COUNT; i++) {
        if (adcFunctionMap[i] == channel)
            return 
# 95 "./src/main/drivers/adc.c" 3 4
                  1
# 95 "./src/main/drivers/adc.c"
                      ;
    }

    return 
# 98 "./src/main/drivers/adc.c" 3 4
          0
...
void adcInit(drv_adc_config_t *init)
{
    ...
    if (isChannelInUse(ADC_CHN_1)) {
        adcConfig[ADC_CHN_1].adcDevice = adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)));
        if (adcConfig[ADC_CHN_1].adcDevice != ADCINVALID) {
            adcConfig[ADC_CHN_1].tag = ((((0) + 1) << 4) | (4));
        }
    }
    ...
    if (isChannelInUse(ADC_CHN_2)) {
        adcConfig[ADC_CHN_2].adcDevice = adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)));
        if (adcConfig[ADC_CHN_2].adcDevice != ADCINVALID) {
            adcConfig[ADC_CHN_2].tag = ((((0) + 1) << 4) | (5));
        }
    }
    ...
    if (isChannelInUse(ADC_CHN_3)) {
        adcConfig[ADC_CHN_3].adcDevice = adcDeviceByInstance(((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)));
        if (adcConfig[ADC_CHN_3].adcDevice != ADCINVALID) {
            adcConfig[ADC_CHN_3].tag = ((((1) + 1) << 4) | (2));
        }
    }
