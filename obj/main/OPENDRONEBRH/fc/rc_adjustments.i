...
static void blackboxLogInflightAdjustmentEvent(adjustmentFunction_e adjustmentFunction, int32_t newValue)
{
    ...
    (void)(newValue);
# 229 "./src/main/fc/rc_adjustments.c"
}
# 249 "./src/main/fc/rc_adjustments.c"
static void applyStepAdjustment(controlRateConfig_t *controlRateConfig, uint8_t adjustmentFunction, int delta)
{
    ...
    switch (adjustmentFunction) {
        case ADJUSTMENT_RC_EXPO:
            newValue = constrain((int)controlRateConfig->stabilized.rcExpo8 + delta, 0, 100);
        ...
        case ADJUSTMENT_RC_YAW_EXPO:
            newValue = constrain((int)controlRateConfig->stabilized.rcYawExpo8 + delta, 0, 100);
        ...
        case ADJUSTMENT_MANUAL_RC_EXPO:
            newValue = constrain((int)controlRateConfig->manual.rcExpo8 + delta, 0, 100);
        ...
        case ADJUSTMENT_MANUAL_RC_YAW_EXPO:
            newValue = constrain((int)controlRateConfig->manual.rcYawExpo8 + delta, 0, 100);
        ...
        case ADJUSTMENT_THROTTLE_EXPO:
            newValue = constrain((int)controlRateConfig->throttle.rcExpo8 + delta, 0, 100);
        ...
        case ADJUSTMENT_PITCH_RATE:
            newValue = constrain((int)controlRateConfig->stabilized.rates[FD_PITCH] + delta, 6, 180);
        ...
        case ADJUSTMENT_ROLL_RATE:
            newValue = constrain((int)controlRateConfig->stabilized.rates[FD_ROLL] + delta, 6, 180);
        ...
        case ADJUSTMENT_YAW_RATE:
            newValue = constrain((int)controlRateConfig->stabilized.rates[FD_YAW] + delta, 2, 180);
...
# 443 "./src/main/fc/rc_adjustments.c"
...
void processRcAdjustments(controlRateConfig_t *controlRateConfig)
{
    ...
    const 
# 449 "./src/main/fc/rc_adjustments.c" 3 4
         _Bool 
# 449 "./src/main/fc/rc_adjustments.c"
    ...
    for (int adjustmentIndex = 0; adjustmentIndex < 4; adjustmentIndex++) {
        ...
        const 
# 463 "./src/main/fc/rc_adjustments.c" 3 4
             _Bool 
# 463 "./src/main/fc/rc_adjustments.c"
