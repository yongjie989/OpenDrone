...
# 46 "./src/main/vcp/platform_config.h"
...
# 105 "./src/main/vcp/hw_config.c"
    GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), &GPIO_InitStructure);

    GPIO_ResetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint16_t)0x1000));

    delay(200);

    GPIO_SetBits(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x08000000) + 0x0000)), ((uint16_t)0x1000));
...
void Set_USBClock(void)
{
    ...
    RCC_USBCLKConfig(RCC_Clocks.SYSCLK_Frequency == 72000000 ? ((uint8_t)0x00) : ((uint8_t)0x01));
...
# 362 "./src/main/vcp/hw_config.c"
uint8_t usbIsConfigured(void)
{
    return (bDeviceState == CONFIGURED);
}
# 374 "./src/main/vcp/hw_config.c"
uint8_t usbIsConnected(void)
{
    return (bDeviceState != UNCONNECTED);
}
# 387 "./src/main/vcp/hw_config.c"
uint32_t CDC_BaudRate(void)
{
