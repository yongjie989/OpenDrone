...
# 57 "./src/main/navigation/navigation_pos_estimator.c" 2
# 65 "./src/main/navigation/navigation_pos_estimator.c"
...
# 92 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 92 "./src/main/navigation/navigation_pos_estimator.c"
               glitchDetected;
    
# 93 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 93 "./src/main/navigation/navigation_pos_estimator.c"
               glitchRecovery;
...
# 126 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 126 "./src/main/navigation/navigation_pos_estimator.c"
               isValid;
    float quality;
    float flowRate[2];
    float bodyRate[2];
...
# 151 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 151 "./src/main/navigation/navigation_pos_estimator.c"
               isBaroGroundValid;
...
# 157 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 157 "./src/main/navigation/navigation_pos_estimator.c"
...
# 209 "./src/main/navigation/navigation_pos_estimator.c"
 ;
...
static 
# 232 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 232 "./src/main/navigation/navigation_pos_estimator.c"
           updateTimer(navigationTimer_t * tim, timeUs_t interval, timeUs_t currentTimeUs)
{
    if ((currentTimeUs - tim->lastTriggeredTime) >= interval) {
        ...
        return 
# 237 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              1
# 237 "./src/main/navigation/navigation_pos_estimator.c"
                  ;
    }
    else {
        return 
# 240 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              0
# 240 "./src/main/navigation/navigation_pos_estimator.c"
                   ;
    }
}

static 
# 244 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 244 "./src/main/navigation/navigation_pos_estimator.c"
           shouldResetReferenceAltitude(void)
{
    switch (positionEstimationConfig()->reset_altitude_type) {
        case NAV_RESET_ALTITUDE_NEVER:
            return 
# 248 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                  0
# 248 "./src/main/navigation/navigation_pos_estimator.c"
                       ;
    ...
    return 
# 255 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          0
# 255 "./src/main/navigation/navigation_pos_estimator.c"
               ;
}
# 265 "./src/main/navigation/navigation_pos_estimator.c"
...
static 
# 278 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 278 "./src/main/navigation/navigation_pos_estimator.c"
...
# 284 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 284 "./src/main/navigation/navigation_pos_estimator.c"
        isGlitching = 
# 284 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                      0
# 284 "./src/main/navigation/navigation_pos_estimator.c"
    ...
    if (previousTime == 0) {
        isGlitching = 
# 287 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                     0
# 287 "./src/main/navigation/navigation_pos_estimator.c"
                          ;
    }
    else {
        ...
        if (gpsDistance <= (250.0f + 0.5f * 1000.0f * dT * dT)) {
            isGlitching = 
# 301 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                         0
# 301 "./src/main/navigation/navigation_pos_estimator.c"
                              ;
        }
        else {
            isGlitching = 
# 304 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                         1
# 304 "./src/main/navigation/navigation_pos_estimator.c"
                             ;
        }
    }
...
void onNewGPSData(void)
{
    ...
    static 
# 328 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          _Bool 
# 328 "./src/main/navigation/navigation_pos_estimator.c"
               isFirstGPSUpdate = 
# 328 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                  1
# 328 "./src/main/navigation/navigation_pos_estimator.c"
    ...
    if (sensors(SENSOR_GPS)) {
        if (!(stateFlags & (GPS_FIX))) {
            isFirstGPSUpdate = 
# 339 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                              1
# 339 "./src/main/navigation/navigation_pos_estimator.c"
                                  ;
            return;
        }
        ...
        if ((currentTimeUs - lastGPSNewDataTime) > ((1500) * 1000)) {
            isFirstGPSUpdate = 
# 344 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                              1
# 344 "./src/main/navigation/navigation_pos_estimator.c"
                                  ;
        }
        ...
        static 
# 349 "./src/main/navigation/navigation_pos_estimator.c" 3 4
              _Bool 
...
# 349 "./src/main/navigation/navigation_pos_estimator.c"
        ...
        if (positionEstimationConfig()->automatic_mag_declination && !magDeclinationSet) {
            ...
            magDeclinationSet = 
# 352 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                               1
# 352 "./src/main/navigation/navigation_pos_estimator.c"
                                   ;
        }
...
# 396 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 396 "./src/main/navigation/navigation_pos_estimator.c"
                                                          ;
                    posEstimator.gps.glitchDetected = 
# 397 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     1
# 397 "./src/main/navigation/navigation_pos_estimator.c"
                    ...
                    posEstimator.gps.glitchDetected = 
# 402 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 402 "./src/main/navigation/navigation_pos_estimator.c"
                                                          ;
                }
            ...
            isFirstGPSUpdate = 
# 423 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                              0
# 423 "./src/main/navigation/navigation_pos_estimator.c"
                                   ;
...
# 544 "./src/main/navigation/navigation_pos_estimator.c"
...
# 555 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 555 "./src/main/navigation/navigation_pos_estimator.c"
                                                          ;
    }
    else {
        fpVector3_t accelBF;
        ...
        if (!(armingFlags & (ARMED)) && !posEstimator.imu.gravityCalibrationComplete) {
            ...
            if (( __extension__ ({ __typeof__(gravityOffsetError) _abs1 = (gravityOffsetError); _abs1 < 0 ? -_abs1 : _abs1; })) < positionEstimationConfig()->gravity_calibration_tolerance) {
                if ((millis() - gravityCalibrationTimeout) > 250) {
                    posEstimator.imu.gravityCalibrationComplete = 
# 586 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                                 1
# 586 "./src/main/navigation/navigation_pos_estimator.c"
                                                                     ;
                }
            }
            else {
...
static 
# 618 "./src/main/navigation/navigation_pos_estimator.c" 3 4
      _Bool 
# 618 "./src/main/navigation/navigation_pos_estimator.c"
...
static void updateEstimatedTopic(timeUs_t currentTimeUs)
{
    ...
    const 
# 657 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 657 "./src/main/navigation/navigation_pos_estimator.c"
              isGPSValid = sensors(SENSOR_GPS) &&
    ...
    const 
# 661 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 661 "./src/main/navigation/navigation_pos_estimator.c"
              isGPSZValid = isGPSValid && (posEstimator.gps.epv < positionEstimationConfig()->max_eph_epv);
    const 
# 662 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 662 "./src/main/navigation/navigation_pos_estimator.c"
              isBaroValid = sensors(SENSOR_BARO) && ((currentTimeUs - posEstimator.baro.lastUpdateTime) <= ((200) * 1000));

    const 
# 664 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 664 "./src/main/navigation/navigation_pos_estimator.c"
              isSurfaceValid = sensors(SENSOR_RANGEFINDER) && ((currentTimeUs - posEstimator.surface.lastUpdateTime) <= ((300) * 1000));
...
# 671 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                  1
# 671 "./src/main/navigation/navigation_pos_estimator.c"
                                                      ;
            ...
            if (posEstimator.est.vel.z > 15) {
                if (currentTimeUs > posEstimator.state.baroGroundTimeout) {
                    posEstimator.state.isBaroGroundValid = 
# 677 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                          0
# 677 "./src/main/navigation/navigation_pos_estimator.c"
                                                               ;
                }
            }
            else {
        ...
        posEstimator.state.isBaroGroundValid = 
# 686 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                              0
# 686 "./src/main/navigation/navigation_pos_estimator.c"
                                                   ;
    }
...
# 691 "./src/main/navigation/navigation_pos_estimator.c" 3 4
   _Bool 
# 691 "./src/main/navigation/navigation_pos_estimator.c"
    ...
    const 
# 697 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 697 "./src/main/navigation/navigation_pos_estimator.c"
              useGpsZPos = (stateFlags & (FIXED_WING)) && !sensors(SENSOR_BARO) && isGPSValid && isGPSZValid;
    const 
# 698 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 698 "./src/main/navigation/navigation_pos_estimator.c"
              useGpsZVel = isGPSValid && isGPSZValid;


    const 
# 701 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 701 "./src/main/navigation/navigation_pos_estimator.c"
              isEstXYValid = (posEstimator.est.eph < positionEstimationConfig()->max_eph_epv);
    const 
# 702 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 702 "./src/main/navigation/navigation_pos_estimator.c"
              isEstZValid = (posEstimator.est.epv < positionEstimationConfig()->max_eph_epv);
    ...
    const 
# 722 "./src/main/navigation/navigation_pos_estimator.c" 3 4
         _Bool 
# 722 "./src/main/navigation/navigation_pos_estimator.c"
              updateAccBias = (positionEstimationConfig()->w_acc_bias > 0);
        ...
        if (!isEstZValid && useGpsZPos) {
            ...
            if (isBaroValid) {
                ...
                if (updateAccBias && !isAirCushionEffectDetected) {
                    accelBiasCorr.z -= baroResidual * ((positionEstimationConfig()->w_z_baro_p)*(positionEstimationConfig()->w_z_baro_p));
                }
            }
            ...
            if (useGpsZPos) {
                ...
                newEPV = updateEPE(posEstimator.est.epv, dt, ( __extension__ ({ __typeof__(posEstimator.gps.epv) _left2 = (posEstimator.gps.epv); __typeof__(gpsResidualZ) _right3 = (gpsResidualZ); _left2 > _right3 ? _left2 : _right3; })), positionEstimationConfig()->w_z_gps_p);

                if (updateAccBias) {
                    accelBiasCorr.z -= gpsResidualZ * ((positionEstimationConfig()->w_z_gps_p)*(positionEstimationConfig()->w_z_gps_p));
                }
            }
            ...
            if (useGpsZVel) {
                ...
                inavFilterCorrectVel(Z, dt, gpsResidualZVel, positionEstimationConfig()->w_z_gps_v * ((gpsWeightScaler)*(gpsWeightScaler)));
            }
        }
    }
    else {
    ...
    if (isGPSValid) {
        ...
        if (!isEstXYValid) {
            ...
            const float gpsResidualXYMagnitude = sqrtf(((gpsResidualX)*(gpsResidualX)) + ((gpsResidualY)*(gpsResidualY)));
    ...
    if (updateAccBias) {
        const float accelBiasCorrMagnitudeSq = ((accelBiasCorr.x)*(accelBiasCorr.x)) + ((accelBiasCorr.y)*(accelBiasCorr.y)) + ((accelBiasCorr.z)*(accelBiasCorr.z));
...
# 935 "./src/main/navigation/navigation_pos_estimator.c"
...
# 956 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     1
# 956 "./src/main/navigation/navigation_pos_estimator.c"
                                                         , posEstimator.est.pos.x, posEstimator.est.pos.y, posEstimator.est.vel.x, posEstimator.est.vel.y);
        }
        else {
            updateActualHorizontalPositionAndVelocity(
# 959 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                     0
# 959 "./src/main/navigation/navigation_pos_estimator.c"
...
# 965 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                            1
# 965 "./src/main/navigation/navigation_pos_estimator.c"
                                                , posEstimator.est.pos.z, posEstimator.est.vel.z, posEstimator.est.aglAlt, posEstimator.est.aglVel, aglStatus);
        }
        else {
            updateActualAltitudeAndClimbRate(
# 968 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                            0
# 968 "./src/main/navigation/navigation_pos_estimator.c"
...
# 979 "./src/main/navigation/navigation_pos_estimator.c" 3 4
_Bool 
# 979 "./src/main/navigation/navigation_pos_estimator.c"
    isGPSGlitchDetected(void)
{
...
void initializePositionEstimator(void)
{
    ...
    posEstimator.imu.gravityCalibrationComplete = 
# 1003 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                                                 0
# 1003 "./src/main/navigation/navigation_pos_estimator.c"
                                                      ;
...
{
    static 
# 1018 "./src/main/navigation/navigation_pos_estimator.c" 3 4
          _Bool 
# 1018 "./src/main/navigation/navigation_pos_estimator.c"
               isInitialized = 
# 1018 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                               0
# 1018 "./src/main/navigation/navigation_pos_estimator.c"
    ...
    if (!isInitialized) {
        ...
        isInitialized = 
# 1022 "./src/main/navigation/navigation_pos_estimator.c" 3 4
                       1
# 1022 "./src/main/navigation/navigation_pos_estimator.c"
                           ;
    }
...
# 1042 "./src/main/navigation/navigation_pos_estimator.c" 3 4
_Bool 
# 1042 "./src/main/navigation/navigation_pos_estimator.c"
    navIsCalibrationComplete(void)
{
