...
static 
# 58 "./src/main/navigation/navigation_fixedwing.c" 3 4
      _Bool 
# 58 "./src/main/navigation/navigation_fixedwing.c"
...
# 58 "./src/main/navigation/navigation_fixedwing.c"
                                         ;
static 
# 59 "./src/main/navigation/navigation_fixedwing.c" 3 4
      _Bool 
# 59 "./src/main/navigation/navigation_fixedwing.c"
...
void resetFixedWingAltitudeController(void)
{
    ...
    isPitchAdjustmentValid = 
# 75 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            0
# 75 "./src/main/navigation/navigation_fixedwing.c"
                                 ;
    throttleSpeedAdjustment = 0;
}


# 79 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 79 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingAltitudeFromRCInput(void)
{
    ...
    if (rcAdjustment) {
        ...
        return 
# 87 "./src/main/navigation/navigation_fixedwing.c" 3 4
              1
# 87 "./src/main/navigation/navigation_fixedwing.c"
                  ;
    }
    else {
...
static void updateAltitudeVelocityAndPitchController_FW(timeDelta_t deltaMicros)
{
    ...
    const float estSPE = (posControl.actualState.pos.z / 100.0f) * 9.80665f;
...
void applyFixedWingAltitudeAndThrottleController(timeUs_t currentTimeUs)
{
    ...
    if ((posControl.flags.estAltStatus >= EST_USABLE)) {
        ...
        isPitchAdjustmentValid = 
# 172 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                1
# 172 "./src/main/navigation/navigation_fixedwing.c"
                                    ;
    }
    else {

        isPitchAdjustmentValid = 
# 176 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                0
# 176 "./src/main/navigation/navigation_fixedwing.c"
                                     ;
    }
}
...
{
    return 
# 185 "./src/main/navigation/navigation_fixedwing.c" 3 4
          0
# 185 "./src/main/navigation/navigation_fixedwing.c"
               ;
}
...
void resetFixedWingPositionController(void)
{
    ...
    isRollAdjustmentValid = 
# 202 "./src/main/navigation/navigation_fixedwing.c" 3 4
                           0
# 202 "./src/main/navigation/navigation_fixedwing.c"
                                ;
...
# 219 "./src/main/navigation/navigation_fixedwing.c" 3 4
   _Bool 
# 219 "./src/main/navigation/navigation_fixedwing.c"
...
# 252 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                                  1
# 252 "./src/main/navigation/navigation_fixedwing.c"
                                                      ;
        }
    }
}
...
# 257 "./src/main/navigation/navigation_fixedwing.c" 3 4
_Bool 
# 257 "./src/main/navigation/navigation_fixedwing.c"
    adjustFixedWingPositionFromRCInput(void)
{
    int16_t rcRollAdjustment = applyDeadband(rcCommand[ROLL], rcControlsConfig()->pos_hold_deadband);
...
# 267 "./src/main/navigation/navigation_fixedwing.c"
               errorIsDecreasing;
    static 
# 268 "./src/main/navigation/navigation_fixedwing.c" 3 4
          _Bool 
# 268 "./src/main/navigation/navigation_fixedwing.c"
               forceTurnDirection = 
# 268 "./src/main/navigation/navigation_fixedwing.c" 3 4
                                    0
# 268 "./src/main/navigation/navigation_fixedwing.c"
...
# 279 "./src/main/navigation/navigation_fixedwing.c"
        ...
        forceTurnDirection = 
# 282 "./src/main/navigation/navigation_fixedwing.c" 3 4
                            0
# 282 "./src/main/navigation/navigation_fixedwing.c"
                                 ;
    }
...
void applyFixedWingPositionController(timeUs_t currentTimeUs)
{
    ...
    if ((posControl.flags.estPosStatue >= EST_USABLE)) {
        ...
        isRollAdjustmentValid = 
# 356 "./src/main/navigation/navigation_fixedwing.c" 3 4
                               1
# 356 "./src/main/navigation/navigation_fixedwing.c"
                                   ;
    }
    else {

        isRollAdjustmentValid = 
# 360 "./src/main/navigation/navigation_fixedwing.c" 3 4
                               0
# 360 "./src/main/navigation/navigation_fixedwing.c"
                                    ;
    }
}
...
# 568 "./src/main/navigation/navigation_fixedwing.c"
