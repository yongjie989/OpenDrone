...
void mspSerialProcess(mspEvaluateNonMspData_e evaluateNonMspData, mspProcessCommandFnPtr mspProcessCommandFn)
{
    for (uint8_t portIndex = 0; portIndex < 3; portIndex++) {
        ...
        mspPostProcessFnPtr mspPostProcessFn = 
# 461 "./src/main/msp/msp_serial.c" 3 4
                                              ((void *)0)
# 461 "./src/main/msp/msp_serial.c"
                                                  ;
        ...
        if (serialRxBytesWaiting(mspPort->port)) {
            ...
            while (serialRxBytesWaiting(mspPort->port)) {
                ...
                const 
# 471 "./src/main/msp/msp_serial.c" 3 4
                     _Bool 
# 471 "./src/main/msp/msp_serial.c"
...
{
    uint32_t ret = 
# 539 "./src/main/msp/msp_serial.c" 3 4
                  (0xffffffffUL)
# 539 "./src/main/msp/msp_serial.c"
                            ;
...
mspPort_t * mspSerialPortFind(const serialPort_t *serialPort)
{
    ...
    return 
# 569 "./src/main/msp/msp_serial.c" 3 4
          ((void *)0)
# 569 "./src/main/msp/msp_serial.c"
              ;
}
