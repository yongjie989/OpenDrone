...
# 97 "./src/main/build/debug.c"
   , "%s/%s %s %s / %s (%s)", "OPENDRONE", targetName, "1" "." "0" "." "1", buildDate, buildTime)
...
# 111 "./src/main/build/debug.c" 3 4
                           _Bool 
# 111 "./src/main/build/debug.c"
...
void debugTracePrintf(
# 132 "./src/main/build/debug.c" 3 4
                     _Bool 
# 132 "./src/main/build/debug.c"
                          synchronous, const char *format, ...)
{
    char buf[128];
    char *bufPtr;
...
# 148 "./src/main/build/debug.c" 3 4
   __builtin_va_start(
# 148 "./src/main/build/debug.c"
   va
# 148 "./src/main/build/debug.c" 3 4
   ,
# 148 "./src/main/build/debug.c"
...
# 153 "./src/main/build/debug.c" 3 4
   __builtin_va_end(
# 153 "./src/main/build/debug.c"
   va
# 153 "./src/main/build/debug.c" 3 4
   )
# 153 "./src/main/build/debug.c"
...
void debugTracePrintBufferHex(
# 158 "./src/main/build/debug.c" 3 4
                             _Bool 
# 158 "./src/main/build/debug.c"
                                  synchronous, const void *buffer, size_t size)
{
