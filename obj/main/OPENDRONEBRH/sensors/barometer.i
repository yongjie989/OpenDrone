...
static 
# 69 "./src/main/sensors/barometer.c" 3 4
      _Bool 
# 69 "./src/main/sensors/barometer.c"
...
# 73 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 73 "./src/main/sensors/barometer.c"
    baroDetect(baroDev_t *dev, baroSensor_e baroHardwareToUse)
{
    ...
    if (baroHardware == BARO_NONE) {
        ...
        return 
# 156 "./src/main/sensors/barometer.c" 3 4
              0
# 156 "./src/main/sensors/barometer.c"
                   ;
    }
    ...
    baroInit(void)
{
    if (!baroDetect(&baro.dev, barometerConfig()->baro_hardware)) {
        return 
# 167 "./src/main/sensors/barometer.c" 3 4
              0
# 167 "./src/main/sensors/barometer.c"
                   ;
    }
    return 
# 169 "./src/main/sensors/barometer.c" 3 4
          1
# 169 "./src/main/sensors/barometer.c"
              ;
}


# 172 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 172 "./src/main/sensors/barometer.c"
    baroIsCalibrationComplete(void)
{
...
void baroStartCalibration(void)
{
    ...
    baroCalibrationFinished = 
# 180 "./src/main/sensors/barometer.c" 3 4
                             0
# 180 "./src/main/sensors/barometer.c"
                                  ;
}
...
static int32_t applyBarometerMedianFilter(int32_t newPressureReading)
{
    ...
    static 
# 199 "./src/main/sensors/barometer.c" 3 4
          _Bool 
# 199 "./src/main/sensors/barometer.c"
               medianFilterReady = 
# 199 "./src/main/sensors/barometer.c" 3 4
                                   0
# 199 "./src/main/sensors/barometer.c"
    ...
    if (nextSampleIndex == 3) {
        nextSampleIndex = 0;
        medianFilterReady = 
# 204 "./src/main/sensors/barometer.c" 3 4
                           1
# 204 "./src/main/sensors/barometer.c"
                               ;
    }
...
# 272 "./src/main/sensors/barometer.c"
                                         ;
            debugTracePrintf(
# 273 "./src/main/sensors/barometer.c" 3 4
           1
# 273 "./src/main/sensors/barometer.c"
...
# 306 "./src/main/sensors/barometer.c" 3 4
_Bool 
# 306 "./src/main/sensors/barometer.c"
    baroIsHealthy(void)
{
    return 
# 308 "./src/main/sensors/barometer.c" 3 4
          1
# 308 "./src/main/sensors/barometer.c"
              ;
}
