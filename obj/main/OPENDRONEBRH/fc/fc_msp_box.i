...
static const box_t boxes[CHECKBOX_ITEM_COUNT + 1] = {
    ...
    { CHECKBOX_ITEM_COUNT, 
# 75 "./src/main/fc/fc_msp_box.c" 3 4
                          ((void *)0)
# 75 "./src/main/fc/fc_msp_box.c"
                              , 0xFF }
};
...
const box_t *findBoxByActiveBoxId(uint8_t activeBoxId)
{
    ...
    return 
# 91 "./src/main/fc/fc_msp_box.c" 3 4
          ((void *)0)
# 91 "./src/main/fc/fc_msp_box.c"
              ;
}
...
const box_t *findBoxByPermanentId(uint8_t permenantId)
{
    ...
    return 
# 102 "./src/main/fc/fc_msp_box.c" 3 4
          ((void *)0)
# 102 "./src/main/fc/fc_msp_box.c"
              ;
}


# 105 "./src/main/fc/fc_msp_box.c" 3 4
_Bool 
# 105 "./src/main/fc/fc_msp_box.c"
...
# 224 "./src/main/fc/fc_msp_box.c"
    activeBoxIds[activeBoxIdCount++] = BOXOSD;


    if (feature(FEATURE_TELEMETRY) && telemetryConfig()->telemetry_switch)
        activeBoxIds[activeBoxIdCount++] = BOXTELEMETRY;
# 237 "./src/main/fc/fc_msp_box.c"
