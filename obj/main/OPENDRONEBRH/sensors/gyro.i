...
extern const gyroConfig_t pgResetTemplate_gyroConfig; gyroConfig_t gyroConfig_System; gyroConfig_t gyroConfig_Copy; extern const pgRegistry_t gyroConfig_Registry; const pgRegistry_t gyroConfig_Registry __attribute__ ((section(".pg_registry"), used, aligned(4))) = { .pgn = 10 | (2 << 12), .size = sizeof(gyroConfig_t) | PGR_SIZE_SYSTEM_FLAG, .address = (uint8_t*)&gyroConfig_System, .copy = (uint8_t*)&gyroConfig_Copy, .ptr = 0, .reset = {.ptr = (void*)&pgResetTemplate_gyroConfig}, };

const gyroConfig_t pgResetTemplate_gyroConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .gyro_lpf = 3, .gyro_soft_lpf_hz = 60, .gyro_align = ALIGN_DEFAULT, .gyroMovementCalibrationThreshold = 32, .looptime = 1000, .gyroSync = 0, .gyro_to_use = 0, .gyro_soft_notch_hz_1 = 0, .gyro_soft_notch_cutoff_1 = 1, .gyro_soft_notch_hz_2 = 0, .gyro_soft_notch_cutoff_2 = 1 }
# 110 "./src/main/sensors/gyro.c"
 ;
...
# 227 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 227 "./src/main/sensors/gyro.c"
    gyroInit(void)
{
    ...
    if (gyroDetect(&gyroDev0, GYRO_AUTODETECT) == GYRO_NONE) {
        return 
# 239 "./src/main/sensors/gyro.c" 3 4
              0
# 239 "./src/main/sensors/gyro.c"
                   ;
    }
    ...
    gyroInitFilters();
    return 
# 256 "./src/main/sensors/gyro.c" 3 4
          1
# 256 "./src/main/sensors/gyro.c"
              ;
}
...
static 
# 306 "./src/main/sensors/gyro.c" 3 4
                  _Bool 
# 306 "./src/main/sensors/gyro.c"
...
# 311 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 311 "./src/main/sensors/gyro.c"
    gyroIsCalibrationComplete(void)
{
    return gyroCalibration.calibratingG == 0;
}
...
static 
# 316 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 316 "./src/main/sensors/gyro.c"
...
static 
# 321 "./src/main/sensors/gyro.c" 3 4
      _Bool 
# 321 "./src/main/sensors/gyro.c"
...
static void performGyroCalibration(gyroDev_t *dev, gyroCalibration_t *gyroCalibration, uint8_t gyroMovementCalibrationThreshold)
{
    ...
    if (isOnFinalGyroCalibrationCycle(gyroCalibration)) {
        debugTracePrintf(
# 355 "./src/main/sensors/gyro.c" 3 4
       1
# 355 "./src/main/sensors/gyro.c"
...
# 443 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 443 "./src/main/sensors/gyro.c"
    gyroReadTemperature(void)
{
    ...
    return 
# 450 "./src/main/sensors/gyro.c" 3 4
          0
# 450 "./src/main/sensors/gyro.c"
               ;
}
...
# 463 "./src/main/sensors/gyro.c" 3 4
_Bool 
# 463 "./src/main/sensors/gyro.c"
    gyroSyncCheckUpdate(void)
{
