...
# 52 "./src/main/drivers/serial_uart.c"
...
{
    uartPort_t *s = 
# 105 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 105 "./src/main/drivers/serial_uart.c"
                       ;

    if (
# 107 "./src/main/drivers/serial_uart.c" 3 4
       0
# 107 "./src/main/drivers/serial_uart.c"
            ) {

    } else if (USARTx == ((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x00003800))) {
...
# 142 "./src/main/drivers/serial_uart.c"
    } else {
...
# 145 "./src/main/drivers/serial_uart.c"
    ...
    if (mode & MODE_RX) {
# 176 "./src/main/drivers/serial_uart.c"
        if (s->rxDMAChannel) {
...
# 199 "./src/main/drivers/serial_uart.c"
    ...
    if (mode & MODE_TX) {
# 230 "./src/main/drivers/serial_uart.c"
        if (s->txDMAChannel) {
            DMA_StructInit(&DMA_InitStructure);
...
# 251 "./src/main/drivers/serial_uart.c"
...
# 301 "./src/main/drivers/serial_uart.c"
    ...
    s->txDMAEmpty = 
# 309 "./src/main/drivers/serial_uart.c" 3 4
                   0
# 309 "./src/main/drivers/serial_uart.c"
                        ;
...
# 358 "./src/main/drivers/serial_uart.c"
    if (s->txDMAChannel) {
...
# 373 "./src/main/drivers/serial_uart.c"
...
# 381 "./src/main/drivers/serial_uart.c" 3 4
_Bool 
# 381 "./src/main/drivers/serial_uart.c"
...
const struct serialPortVTable uartVTable[] = {
    {
        ...
        .setMode = uartSetMode,
        .isConnected = 
# 451 "./src/main/drivers/serial_uart.c" 3 4
                      ((void *)0)
# 451 "./src/main/drivers/serial_uart.c"
                          ,
        .writeBuf = 
# 452 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 452 "./src/main/drivers/serial_uart.c"
                       ,
        .beginWrite = 
# 453 "./src/main/drivers/serial_uart.c" 3 4
                     ((void *)0)
# 453 "./src/main/drivers/serial_uart.c"
                         ,
        .endWrite = 
# 454 "./src/main/drivers/serial_uart.c" 3 4
                   ((void *)0)
# 454 "./src/main/drivers/serial_uart.c"
                       ,
    }
};
