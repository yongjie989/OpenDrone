...
# 35 "./src/main/drivers/gps_i2cnav.h" 3 4
_Bool 
# 35 "./src/main/drivers/gps_i2cnav.h"
    i2cnavGPSModuleDetect(void);
...
# 50 "./src/main/drivers/gps_i2cnav.c" 3 4
_Bool 
# 50 "./src/main/drivers/gps_i2cnav.c"
    i2cnavGPSModuleDetect(void)
{
    
# 52 "./src/main/drivers/gps_i2cnav.c" 3 4
   _Bool 
# 52 "./src/main/drivers/gps_i2cnav.c"
        ack;
    ...
    if (ack)
        return 
# 58 "./src/main/drivers/gps_i2cnav.c" 3 4
              1
# 58 "./src/main/drivers/gps_i2cnav.c"
                  ;

    return 
# 60 "./src/main/drivers/gps_i2cnav.c" 3 4
          0
# 60 "./src/main/drivers/gps_i2cnav.c"
               ;
}
...
# 70 "./src/main/drivers/gps_i2cnav.c" 3 4
   _Bool 
# 70 "./src/main/drivers/gps_i2cnav.c"
        ack = i2cRead(I2CDEV_1, 0x20, 00, 1, &i2cGpsStatus);
