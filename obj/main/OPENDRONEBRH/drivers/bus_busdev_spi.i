...
# 40 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 40 "./src/main/drivers/bus_busdev_spi.c"
    spiBusTransferMultiple(const busDevice_t * dev, busTransferDescriptor_t * dsc, int count)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    return 
# 54 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 54 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 57 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 57 "./src/main/drivers/bus_busdev_spi.c"
    spiBusWriteRegister(const busDevice_t * dev, uint8_t reg, uint8_t data)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
    ...
    return 
# 68 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 68 "./src/main/drivers/bus_busdev_spi.c"
              ;
}


# 71 "./src/main/drivers/bus_busdev_spi.c" 3 4
_Bool 
# 71 "./src/main/drivers/bus_busdev_spi.c"
    spiBusWriteBuffer(const busDevice_t * dev, uint8_t reg, const uint8_t * data, uint8_t length)
{
    SPI_TypeDef * instance = spiInstanceByDevice(dev->busdev.spi.spiBus);
...
# 77 "./src/main/drivers/bus_busdev_spi.c"
    ...
    return 
# 80 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 80 "./src/main/drivers/bus_busdev_spi.c"
              ;
}
...
# 89 "./src/main/drivers/bus_busdev_spi.c"
    ...
    return 
# 92 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 92 "./src/main/drivers/bus_busdev_spi.c"
              ;
}
...
# 101 "./src/main/drivers/bus_busdev_spi.c"
    ...
    return 
# 104 "./src/main/drivers/bus_busdev_spi.c" 3 4
          1
# 104 "./src/main/drivers/bus_busdev_spi.c"
              ;
}
