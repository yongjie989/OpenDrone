...
static adcDevice_t adcHardware[ADCDEV_COUNT] = {
    { .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0000)), .rccADC = (((RCC_AHB) << 5) | (16*((((uint32_t)0x10000000))>65535L) + (8*(((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L)) >>8*(((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L)) >>8*(((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L))>255))/2+1))))), .rccDMA = (((RCC_AHB) << 5) | (16*((((uint32_t)0x00000001))>65535L) + (8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L)) >>8*(((((uint32_t)0x00000001))*1L >>16*((((uint32_t)0x00000001))>65535L))>255))/2+1))))), .DMAy_Channelx = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000008)), .enabled = 
# 37 "./src/main/drivers/adc_stm32f30x.c" 3 4
                                                                                                                 0
# 37 "./src/main/drivers/adc_stm32f30x.c"
                                                                                                                      , .usedChannelCount = 0 },
    { .ADCx = ((ADC_TypeDef *) ((((uint32_t)0x40000000) + 0x10000000) + 0x0100)), .rccADC = (((RCC_AHB) << 5) | (16*((((uint32_t)0x10000000))>65535L) + (8*(((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L))>255) + (8 - 90/(((((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L)) >>8*(((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L)) >>8*(((((uint32_t)0x10000000))*1L >>16*((((uint32_t)0x10000000))>65535L))>255))/2+1))))), .rccDMA = (((RCC_AHB) << 5) | (16*((((uint32_t)0x00000002))>65535L) + (8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255) + (8 - 90/(((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/4+14)|1) - 2/((((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L)) >>8*(((((uint32_t)0x00000002))*1L >>16*((((uint32_t)0x00000002))>65535L))>255))/2+1))))), .DMAy_Channelx = ((DMA_Channel_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x00000408)), .enabled = 
# 38 "./src/main/drivers/adc_stm32f30x.c" 3 4
                                                                                                                 0
# 38 "./src/main/drivers/adc_stm32f30x.c"
                                                                                                                      , .usedChannelCount = 0 }
};

const adcTagMap_t adcTagMap[] = {
    { ((((0) + 1) << 4) | (0)), ((uint8_t)0x01) },
    { ((((0) + 1) << 4) | (1)), ((uint8_t)0x02) },
    { ((((0) + 1) << 4) | (2)), ((uint8_t)0x03) },
    { ((((0) + 1) << 4) | (3)), ((uint8_t)0x04) },
    { ((((0) + 1) << 4) | (4)), ((uint8_t)0x01) },
    { ((((0) + 1) << 4) | (5)), ((uint8_t)0x02) },
    { ((((0) + 1) << 4) | (6)), ((uint8_t)0x03) },
    { ((((0) + 1) << 4) | (7)), ((uint8_t)0x04) },
    { ((((1) + 1) << 4) | (0)), ((uint8_t)0x0C) },
    { ((((1) + 1) << 4) | (1)), ((uint8_t)0x01) },
    { ((((1) + 1) << 4) | (2)), ((uint8_t)0x0C) },
    { ((((1) + 1) << 4) | (12)), ((uint8_t)0x03) },
    { ((((1) + 1) << 4) | (13)), ((uint8_t)0x05) },
    { ((((1) + 1) << 4) | (14)), ((uint8_t)0x04) },
    { ((((1) + 1) << 4) | (15)), ((uint8_t)0x05) },
    { 0, ((uint8_t)0x06) },
    { 0, ((uint8_t)0x07) },
    { 0, ((uint8_t)0x08) },
    { 0, ((uint8_t)0x09) },
...
void adcHardwareInit(drv_adc_config_t *init)
{
    ...
    for (int i = ADC_CHN_1; i < ADC_CHN_COUNT; i++) {
        ...
        adcConfig[i].enabled = 
# 192 "./src/main/drivers/adc_stm32f30x.c" 3 4
                              1
# 192 "./src/main/drivers/adc_stm32f30x.c"
                                  ;

        adc->enabled = 
# 194 "./src/main/drivers/adc_stm32f30x.c" 3 4
                      1
# 194 "./src/main/drivers/adc_stm32f30x.c"
                          ;
