...
# 68 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 68 "./src/main/drivers/pwm_mapping.h"
        useUART3;
    
# 69 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 69 "./src/main/drivers/pwm_mapping.h"
        useUART6;
    
# 70 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 70 "./src/main/drivers/pwm_mapping.h"
        useVbat;
    
# 71 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 71 "./src/main/drivers/pwm_mapping.h"
        useFastPwm;
    
# 72 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 72 "./src/main/drivers/pwm_mapping.h"
        useSoftSerial;
    
# 73 "./src/main/drivers/pwm_mapping.h" 3 4
   _Bool 
# 73 "./src/main/drivers/pwm_mapping.h"
        useLEDStrip;
...
typedef struct pwmIOConfiguration_s {
    ...
    pwmPortConfiguration_t ioConfigurations[12];
...
# 88 "./src/main/drivers/vtx_common.h" 3 4
_Bool 
# 88 "./src/main/drivers/vtx_common.h"
...
#define OPENDRONE_IDENTIFIER "ODBR"
...
static const char * const flightControllerIdentifier = "ODBR";
static const char * const boardIdentifier = "ODBR";
...
static void mspRebootFn(serialPort_t *serialPort)
{
    ...
    while (
# 193 "./src/main/fc/fc_msp.c" 3 4
          1
# 193 "./src/main/fc/fc_msp.c"
              ) ;
}

static void serializeSDCardSummaryReply(sbuf_t *dst)
{
# 235 "./src/main/fc/fc_msp.c"
    sbufWriteU8(dst, 0);
    sbufWriteU8(dst, 0);
    sbufWriteU8(dst, 0);
    sbufWriteU32(dst, 0);
...
# 286 "./src/main/fc/fc_msp.c"
static 
# 286 "./src/main/fc/fc_msp.c" 3 4
      _Bool 
# 286 "./src/main/fc/fc_msp.c"
           mspFcProcessOutCommand(uint16_t cmdMSP, sbuf_t *dst, mspPostProcessFnPtr *mspPostProcessFn)
{
    switch (cmdMSP) {
    case 1:
        sbufWriteU8(dst, 0);
...
# 361 "./src/main/fc/fc_msp.c"
    ...
    case 0x2002:
        ...
        sbufWriteU16(dst, constrain(getPower(), 0, 0x7FFFFFFF));
        sbufWriteU16(dst, (uint16_t)constrain(getMAhDrawn(), 0, 0xFFFF));
        sbufWriteU16(dst, (uint16_t)constrain(getMWhDrawn(), 0, 0xFFFF));
        sbufWriteU16(dst, getRSSI());
        sbufWriteU16(dst, (int16_t)constrain(getAmperage(), -0x8000, 0x7FFF));
    ...
    case 0x2007:
        ...
        for (uint8_t i = 0 ; i < 3; ++i) {
            sbufWriteU8(dst, currentControlRateProfile->manual.rates[i]);
        }
        break;
    ...
    case 116:
        if (!serializeBoxNamesReply(dst)) {
            return 
# 643 "./src/main/fc/fc_msp.c" 3 4
                  0
# 643 "./src/main/fc/fc_msp.c"
                       ;
        }
        break;
    ...
    case 64:
        sbufWriteData(dst, rxConfig()->rcmap, 4);
        break;
...
# 976 "./src/main/fc/fc_msp.c"
    ...
    case 92 :
        ...
        sbufWriteU16(dst, pidProfile()->dterm_soft_notch_hz);
        sbufWriteU16(dst, pidProfile()->dterm_soft_notch_cutoff);
...
# 1283 "./src/main/fc/fc_msp.c"
    ...
    default:
        return 
# 1305 "./src/main/fc/fc_msp.c" 3 4
              0
# 1305 "./src/main/fc/fc_msp.c"
                   ;
    }
    return 
# 1307 "./src/main/fc/fc_msp.c" 3 4
          1
# 1307 "./src/main/fc/fc_msp.c"
              ;
}
...
static mspResult_e mspFcProcessInCommand(uint16_t cmdMSP, sbuf_t *src)
{
    ...
    switch (cmdMSP) {
    case 210:
        if (sbufReadU8Safe(&tmp_u8, src) && (!(armingFlags & (ARMED))))
    ...
    case 200:
        {
            ...
            if ((channelCount > 18) || (dataSize > channelCount * sizeof(uint16_t))) {
                return MSP_RESULT_ERROR;
            } else {
                uint16_t frame[18];
    ...
    case 62:
        if (dataSize >= 2) {
            armingConfigMutable()->auto_disarm_delay = constrain(sbufReadU8(src), 0, 60);
    ...
    case 204:
        if ((dataSize >= 10) && (dataSize <= 11)) {
            ...
            for (int i = 0; i < 3; i++) {
                tmp_u8 = sbufReadU8(src);
                if (i == FD_YAW) {
                    ((controlRateConfig_t*)currentControlRateProfile)->stabilized.rates[i] = constrain(tmp_u8, 2, 180);
                }
                else {
                    ((controlRateConfig_t*)currentControlRateProfile)->stabilized.rates[i] = constrain(tmp_u8, 6, 180);
                }
            }
            tmp_u8 = sbufReadU8(src);
            ((controlRateConfig_t*)currentControlRateProfile)->throttle.dynPID = ( __extension__ ({ __typeof__(tmp_u8) _left0 = (tmp_u8); __typeof__(100) _right1 = (100); _left0 < _right1 ? _left0 : _right1; }));
    ...
    case 0x2008:
        if (dataSize == 15) {
            controlRateConfig_t *currentControlRateProfile_p = (controlRateConfig_t*)currentControlRateProfile;
            ...
            for (uint8_t i = 0; i < 3; ++i) {
                tmp_u8 = sbufReadU8(src);
                if (i == FD_YAW) {
                    currentControlRateProfile_p->stabilized.rates[i] = constrain(tmp_u8, 2, 180);
                } else {
                    currentControlRateProfile_p->stabilized.rates[i] = constrain(tmp_u8, 6, 180);
                }
            }
            ...
            for (uint8_t i = 0; i < 3; ++i) {
                tmp_u8 = sbufReadU8(src);
                if (i == FD_YAW) {
                    currentControlRateProfile_p->manual.rates[i] = constrain(tmp_u8, 2, 180);
                } else {
                    currentControlRateProfile_p->manual.rates[i] = constrain(tmp_u8, 6, 180);
                }
            }
    ...
    case 207:
        if (dataSize >= 22) {
        rxConfigMutable()->midrc = constrain(sbufReadU16(src), 1200, 1700);

        motorConfigMutable()->minthrottle = constrain(sbufReadU16(src), 1000, 2000);
        motorConfigMutable()->maxthrottle = constrain(sbufReadU16(src), 1000, 2000);
        motorConfigMutable()->mincommand = constrain(sbufReadU16(src), 0, 2000);

        failsafeConfigMutable()->failsafe_throttle = constrain(sbufReadU16(src), 1000, 2000);
    ...
    case 0x2004:
        if (dataSize == 37) {
            ...
            motorConfigMutable()->minthrottle = constrain(sbufReadU16(src), 1000, 2000);
            motorConfigMutable()->maxthrottle = constrain(sbufReadU16(src), 1000, 2000);
            motorConfigMutable()->mincommand = constrain(sbufReadU16(src), 1000, 2000);
...
# 2092 "./src/main/fc/fc_msp.c"
    ...
    case 55:
        ...
        break;
# 2336 "./src/main/fc/fc_msp.c"
    case 18:
        sbufReadU8Safe(
# 2337 "./src/main/fc/fc_msp.c" 3 4
                      ((void *)0)
# 2337 "./src/main/fc/fc_msp.c"
                          , src);
    ...
    case 19:
        sbufReadU8Safe(
# 2343 "./src/main/fc/fc_msp.c" 3 4
                      ((void *)0)
# 2343 "./src/main/fc/fc_msp.c"
                          , src);
    ...
    case 11:
        if (dataSize <= 16) {
            ...
            int len = ( __extension__ ({ __typeof__(16) _left2 = (16); __typeof__((int)dataSize) _right3 = ((int)dataSize); _left2 < _right3 ? _left2 : _right3; }));
            sbufReadData(src, name, len);
            memset(&name[len], '\0', (16 + 1) - len);
        } else
            return MSP_RESULT_ERROR;
        break;
...
static const setting_t *mspReadSettingName(sbuf_t *src)
{
    ...
    while (1) {
        if (!sbufReadU8Safe(&c, src)) {
            return 
# 2404 "./src/main/fc/fc_msp.c" 3 4
                  ((void *)0)
# 2404 "./src/main/fc/fc_msp.c"
                      ;
        }
        name[s++] = c;
        if (c == '\0') {
        ...
        if (s == 32) {
            ...
            return 
# 2412 "./src/main/fc/fc_msp.c" 3 4
                  ((void *)0)
# 2412 "./src/main/fc/fc_msp.c"
                      ;
        }
    }
...
static 
# 2418 "./src/main/fc/fc_msp.c" 3 4
      _Bool 
# 2418 "./src/main/fc/fc_msp.c"
           mspSettingCommand(sbuf_t *dst, sbuf_t *src)
{
    const setting_t *setting = mspReadSettingName(src);
    if (!setting) {
        return 
# 2422 "./src/main/fc/fc_msp.c" 3 4
              0
# 2422 "./src/main/fc/fc_msp.c"
                   ;
    }
    ...
    return 
# 2428 "./src/main/fc/fc_msp.c" 3 4
          1
# 2428 "./src/main/fc/fc_msp.c"
              ;
}

static 
# 2431 "./src/main/fc/fc_msp.c" 3 4
      _Bool 
# 2431 "./src/main/fc/fc_msp.c"
           mspSetSettingCommand(sbuf_t *dst, sbuf_t *src)
{
    (void)(dst);
    ...
    if (!setting) {
        return 
# 2437 "./src/main/fc/fc_msp.c" 3 4
              0
# 2437 "./src/main/fc/fc_msp.c"
                   ;
    }
        ...
        case VAR_UINT8:
            {
                ...
                if (!sbufReadU8Safe(&val, src)) {
                    return 
# 2449 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2449 "./src/main/fc/fc_msp.c"
                               ;
                }
                if (val > max) {
                    return 
# 2452 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2452 "./src/main/fc/fc_msp.c"
                               ;
                }
                *((uint8_t*)ptr) = val;
            }
        ...
        case VAR_INT8:
            {
                ...
                if (!sbufReadI8Safe(&val, src)) {
                    return 
# 2461 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2461 "./src/main/fc/fc_msp.c"
                               ;
                }
                if (val < min || val > (int8_t)max) {
                    return 
# 2464 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2464 "./src/main/fc/fc_msp.c"
                               ;
                }
                *((int8_t*)ptr) = val;
            }
        ...
        case VAR_UINT16:
            {
                ...
                if (!sbufReadU16Safe(&val, src)) {
                    return 
# 2473 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2473 "./src/main/fc/fc_msp.c"
                               ;
                }
                if (val > max) {
                    return 
# 2476 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2476 "./src/main/fc/fc_msp.c"
                               ;
                }
                *((uint16_t*)ptr) = val;
            }
        ...
        case VAR_INT16:
            {
                ...
                if (!sbufReadI16Safe(&val, src)) {
                    return 
# 2485 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2485 "./src/main/fc/fc_msp.c"
                               ;
                }
                if (val < min || val > (int16_t)max) {
                    return 
# 2488 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2488 "./src/main/fc/fc_msp.c"
                               ;
                }
                *((int16_t*)ptr) = val;
            }
        ...
        case VAR_UINT32:
            {
                ...
                if (!sbufReadU32Safe(&val, src)) {
                    return 
# 2497 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2497 "./src/main/fc/fc_msp.c"
                               ;
                }
                if (val > max) {
                    return 
# 2500 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2500 "./src/main/fc/fc_msp.c"
                               ;
                }
                *((uint32_t*)ptr) = val;
            }
        ...
        case VAR_FLOAT:
            {
                ...
                if (!sbufReadDataSafe(src, &val, sizeof(float))) {
                    return 
# 2509 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2509 "./src/main/fc/fc_msp.c"
                               ;
                }
                if (val < (float)min || val > (float)max) {
                    return 
# 2512 "./src/main/fc/fc_msp.c" 3 4
                          0
# 2512 "./src/main/fc/fc_msp.c"
                               ;
                }
                *((float*)ptr) = val;
            }
    ...
    return 
# 2519 "./src/main/fc/fc_msp.c" 3 4
          1
# 2519 "./src/main/fc/fc_msp.c"
              ;
}
