...
# 62 "./src/main/telemetry/frsky.c" 3 4
                                ((void *)0)
# 62 "./src/main/telemetry/frsky.c"
                                    ;
...
static 
# 68 "./src/main/telemetry/frsky.c" 3 4
      _Bool 
# 68 "./src/main/telemetry/frsky.c"
...
static void sendThrottleOrBatterySizeAsRpm(void)
{
    ...
    if ((armingFlags & (ARMED))) {
        ...
        serialize16((batteryConfig()->capacity.value / 5));
    }
...
static void sendVoltage(void)
{
    ...
    uint16_t payload;
# 368 "./src/main/telemetry/frsky.c"
...
void freeFrSkyTelemetryPort(void)
{
    ...
    frskyPort = 
# 440 "./src/main/telemetry/frsky.c" 3 4
               ((void *)0)
# 440 "./src/main/telemetry/frsky.c"
                   ;
    frskyTelemetryEnabled = 
# 441 "./src/main/telemetry/frsky.c" 3 4
                           0
# 441 "./src/main/telemetry/frsky.c"
                                ;
}
...
# 450 "./src/main/telemetry/frsky.c" 3 4
                                                                                ((void *)0)
# 450 "./src/main/telemetry/frsky.c"
                                                                                    , 
# 450 "./src/main/telemetry/frsky.c" 3 4
                                                                                      ((void *)0)
# 450 "./src/main/telemetry/frsky.c"
    ...
    frskyTelemetryEnabled = 
# 455 "./src/main/telemetry/frsky.c" 3 4
                           1
# 455 "./src/main/telemetry/frsky.c"
                               ;
}


# 458 "./src/main/telemetry/frsky.c" 3 4
_Bool 
# 458 "./src/main/telemetry/frsky.c"
...
# 466 "./src/main/telemetry/frsky.c" 3 4
                                                            ((void *)0)
# 466 "./src/main/telemetry/frsky.c"
                                                                ) {
            frskyPort = telemetrySharedPort;
            frskyTelemetryEnabled = 
# 468 "./src/main/telemetry/frsky.c" 3 4
                                   1
# 468 "./src/main/telemetry/frsky.c"
                                       ;
        }
    } else {
        
# 471 "./src/main/telemetry/frsky.c" 3 4
       _Bool 
# 471 "./src/main/telemetry/frsky.c"
