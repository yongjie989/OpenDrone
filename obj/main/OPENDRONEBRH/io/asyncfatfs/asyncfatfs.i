...
# 448 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 448 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 462 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 462 "./src/main/io/asyncfatfs/asyncfatfs.c"
        filesystemFull;
...
static 
# 510 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 510 "./src/main/io/asyncfatfs/asyncfatfs.c"
           isPowerOfTwo(unsigned int x)
{
    return ((x != 0) && ((x & (~x + 1)) == x));
}
# 522 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 522 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 522 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_assert(
# 522 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
...
static 
# 537 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 537 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 608 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                  _Bool 
# 608 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                       locked)
{
...
static void afatfs_sdcardReadComplete(sdcardBlockOperation_e operation, uint32_t sectorIndex, uint8_t *buffer, uint32_t callbackData)
{
    ...
    for (int i = 0; i < 8; i++) {
        if (afatfs.cacheDescriptor[i].state != AFATFS_CACHE_STATE_EMPTY
            ...
            if (buffer == 
# 635 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 635 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
# 657 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    for (int i = 0; i < 8; i++) {
        ...
        if (afatfs.cacheDescriptor[i].sectorIndex == sectorIndex
            ...
            if (buffer == 
# 666 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         ((void *)0)
# 666 "./src/main/io/asyncfatfs/asyncfatfs.c"
                             ) {
...
static void afatfs_cacheFlushSector(int cacheIndex)
{
    ...
    switch (sdcard_writeBlock(cacheDescriptor->sectorIndex, afatfs_cacheSectorGetMemory(cacheIndex), afatfs_sdcardWriteComplete, 0)) {
        case SDCARD_OPERATION_IN_PROGRESS:
            ...
            afatfs.cacheFlushInProgress = 
# 698 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                         1
# 698 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                             ;
            break;
...
static afatfsCacheBlockDescriptor_t* afatfs_findCacheSector(uint32_t sectorIndex)
{
    ...
    return 
# 726 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 726 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 740 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 814 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 814 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_flush(void)
{
    if (afatfs.cacheDirtyEntries > 0) {
        ...
        if (earliestSectorIndex > -1) {
            ...
            return 
# 834 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 834 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }

    return 
# 838 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 838 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
# 844 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 844 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_isFull(void)
{
...
# 901 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 936 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 936 "./src/main/io/asyncfatfs/asyncfatfs.c"
                            ) ? (eraseCount) : (
# 936 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                            (0xffff)
# 936 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        default:
            ...
            afatfs_assert(
# 965 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 965 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_OPERATION_FAILURE;
    }
}
           ...
           afatfs_parseMBR(const uint8_t *sector)
{
    ...
    if (sector[512 - 2] != 0x55 || sector[512 - 1] != 0xAA)
        return 
# 977 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 977 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
...
# 993 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 997 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          0
# 997 "./src/main/io/asyncfatfs/asyncfatfs.c"
               ;
}

static 
# 1000 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1000 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_parseVolumeID(const uint8_t *sector)
{
    ...
    if (volume->bytesPerSector != 512 || volume->numFATs != 2
        ...
        return 
# 1008 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1008 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
...
# 1015 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (afatfs.numClusters <= 4084) {
        ...
        return 
# 1032 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1032 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
...
static 
# 1071 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1071 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1093 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1121 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1188 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1194 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
   _Bool 
# 1194 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    switch (condition) {
        ...
        default:
            afatfs_assert(
# 1215 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                         0
# 1215 "./src/main/io/asyncfatfs/asyncfatfs.c"
                              );
            return AFATFS_FIND_CLUSTER_FATAL;
    }
...
# 1292 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1331 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1373 "./src/main/io/asyncfatfs/asyncfatfs.c"
        switch (pattern) {
...
# 1432 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1498 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1574 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                   1
# 1574 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                       ;
            return AFATFS_OPERATION_FAILURE;
        break;
    }
...
# 1603 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1640 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 1663 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static afatfsOperationStatus_e afatfs_appendSupercluster(afatfsFilePtr_t file)
{
    ...
    if (afatfs.freeFile.logicalSize < superClusterSize) {
        afatfs.filesystemFull = 
# 1737 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               1
# 1737 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ;
    }
...
static 
# 1780 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1780 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static uint8_t* afatfs_fileRetainCursorSectorForRead(afatfsFilePtr_t file)
{
    ...
    if (file->readRetainCacheIndex != -1) {
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->readRetainCacheIndex].sectorIndex)) {
            return 
# 1806 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1806 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file)) {
            return 
# 1812 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1812 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1826 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1826 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
static uint8_t* afatfs_fileLockCursorSectorForWrite(afatfsFilePtr_t file)
{
    ...
    if (file->writeLockedCacheIndex != -1) {
        ...
        if (!afatfs_assert(physicalSector == afatfs.cacheDescriptor[file->writeLockedCacheIndex].sectorIndex)) {
            return 
# 1851 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1851 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (afatfs_isEndOfAllocatedFile(file) && afatfs_appendFreeCluster(file) != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1861 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1861 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
        ...
        if (status != AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 1899 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 1899 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
        }
...
# 1920 "./src/main/io/asyncfatfs/asyncfatfs.c"
static 
# 1920 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1920 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekAtomic(afatfsFilePtr_t file, int32_t offset)
{
    ...
    if (newSectorOffset < 512) {
        ...
        return 
# 1928 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 1928 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
...
# 1938 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (offset > (int32_t) clusterSizeBytes || offset < -(int32_t) offsetInCluster) {
        return 
# 1948 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 1948 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    }
...
# 1968 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 1977 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 1977 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
...
static 
# 1983 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
      _Bool 
# 1983 "./src/main/io/asyncfatfs/asyncfatfs.c"
           afatfs_fseekInternalContinue(afatfsFile_t *file)
{
    ...
    while (offsetInCluster + opState->seekOffset >= clusterSizeBytes && !afatfs_isEndOfAllocatedFile(file)) {
        ...
        if (status == AFATFS_OPERATION_SUCCESS) {
            ...
            return 
# 2009 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2009 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
    }
    ...
    return 
# 2026 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2026 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2040 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2086 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                                      ((void *)0)
# 2086 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                                          );
            }
...
# 2116 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                                ((void *)0)
# 2116 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                    );
}
...
# 2127 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        *position = file->cursorOffset;
        return 
# 2130 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2130 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2142 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsOperationStatus_e afatfs_findNext(afatfsFilePtr_t directory, afatfsFinder_t *finder, fatDirectoryEntry_t **dirEntry)
{
    uint8_t *sector;
    ...
    if (sector) {
        ...
        *dirEntry = (fatDirectoryEntry_t*) sector + finder->entryIndex;
        ...
        if (afatfs_isEndOfAllocatedFile(directory)) {
            *dirEntry = 
# 2167 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                       ((void *)0)
# 2167 "./src/main/io/asyncfatfs/asyncfatfs.c"
                           ;
...
static afatfsOperationStatus_e afatfs_extendSubdirectoryContinue(afatfsFile_t *directory)
{
    ...
    switch (opState->phase) {
        ...
        case AFATFS_EXTEND_SUBDIRECTORY_PHASE_FAILURE:
            ...
            if (opState->callback) {
                opState->callback(
# 2275 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                 ((void *)0)
# 2275 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                     );
            }
            return AFATFS_OPERATION_FAILURE;
        break;
...
# 2295 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2334 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2352 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                         ((void *)0)
# 2352 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                             , 
# 2352 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                               ((void *)0)
# 2352 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
static afatfsFilePtr_t afatfs_allocateFileHandle(void)
{
    ...
    return 
# 2379 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          ((void *)0)
# 2379 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2389 "./src/main/io/asyncfatfs/asyncfatfs.c"
static afatfsOperationStatus_e afatfs_ftruncateContinue(afatfsFilePtr_t file, 
# 2389 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                                             _Bool 
# 2389 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                                  markDeleted)
{
...
# 2496 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2496 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2496 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_ftruncate(afatfsFilePtr_t file, afatfsFileCallback_t callback)
{
    ...
    if (afatfs_fileIsBusy(file))
        return 
# 2501 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2501 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    ...
    return 
# 2529 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2529 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
            ...
            do {
                ...
                switch (status) {
                    case AFATFS_OPERATION_SUCCESS:
                        ...
                        if (entry == 
# 2565 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                    ((void *)0) 
# 2565 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_CREATEFILE_PHASE_FAILURE:
            ...
            opState->callback(
# 2691 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                             ((void *)0)
# 2691 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                 );
        break;
    }
}
...
# 2711 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           1
# 2711 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
...
# 2726 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2726 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_funlink(afatfsFilePtr_t file, afatfsCallback_t callback)
{
    afatfsUnlinkFile_t *opState = &file->operation.state.unlinkFile;
...
# 2740 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                               ((void *)0)
# 2740 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                   ))
        return 
...
# 2741 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 2751 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 2751 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
# 2764 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2819 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2863 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2863 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2863 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fclose(afatfsFilePtr_t file, afatfsCallback_t callback)
{
...
# 2866 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        return 
# 2868 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              0
# 2868 "./src/main/io/asyncfatfs/asyncfatfs.c"
                   ;
    } else {
        afatfs_fileUpdateFilesize(file);
        ...
        return 
# 2875 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2875 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
    ...
    afatfs_mkdir(const char *filename, afatfsFileCallback_t callback)
{
    ...
    if (file) {
        ...
        callback(
# 2893 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 2893 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }
...
# 2906 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2906 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2906 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 2909 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    if (directory) {
        if (afatfs_fileIsBusy(directory)) {
            return 
# 2914 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 2914 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        memcpy(&afatfs.currentDirectory, directory, sizeof(*directory));
        return 
# 2918 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2918 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    } else {
        ...
        return 
# 2937 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
              1
# 2937 "./src/main/io/asyncfatfs/asyncfatfs.c"
                  ;
    }
}
# 2967 "./src/main/io/asyncfatfs/asyncfatfs.c"

# 2967 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 2967 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_fopen(const char *filename, const char *mode, afatfsFileCallback_t complete)
{
    ...
    if (file) {
        ...
        complete(
# 3004 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                ((void *)0)
# 3004 "./src/main/io/asyncfatfs/asyncfatfs.c"
                    );
    }

    return file != 
# 3007 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  ((void *)0)
# 3007 "./src/main/io/asyncfatfs/asyncfatfs.c"
                      ;
}
...
# 3044 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fwrite(afatfsFilePtr_t file, const uint8_t *buffer, uint32_t len)
{
    if ((file->mode & (4 | 2)) == 0) {
        return 0;
...
# 3081 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToWriteThisSector, 
# 3081 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                              ((void *)0)
# 3081 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                  ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3111 "./src/main/io/asyncfatfs/asyncfatfs.c"
uint32_t afatfs_fread(afatfsFilePtr_t file, uint8_t *buffer, uint32_t len)
{
    if ((file->mode & 1) == 0) {
        return 0;
...
# 3156 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs_fseekInternal(file, bytesToReadThisSector, 
# 3156 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                             ((void *)0)
# 3156 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                                 ) == AFATFS_OPERATION_IN_PROGRESS) {
            break;
...
# 3172 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
# 3172 "./src/main/io/asyncfatfs/asyncfatfs.c"
    afatfs_feof(afatfsFilePtr_t file)
{
...
# 3199 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                          0
# 3199 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
        break;
...
# 3269 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3374 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        case AFATFS_INITIALIZATION_READ_VOLUME_ID:
            if (afatfs_cacheSector(afatfs.partitionStartSector, &sector, 1 | 8, 0) == AFATFS_OPERATION_SUCCESS) {
                if (afatfs_parseVolumeID(sector)) {
                    ...
                    afatfs_chdir(
# 3400 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                ((void *)0)
# 3400 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        break;
# 3494 "./src/main/io/asyncfatfs/asyncfatfs.c"
...
# 3567 "./src/main/io/asyncfatfs/asyncfatfs.c"
afatfsFilesystemState_e afatfs_getFilesystemState(void)
{
...
# 3593 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
_Bool 
...
# 3601 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                                   ((void *)0)
# 3601 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                                       );

                openFileCount++;
            }
        }
# 3615 "./src/main/io/asyncfatfs/asyncfatfs.c"
        if (afatfs.freeFile.type != AFATFS_FILE_TYPE_NONE) {
            afatfs_fclose(&afatfs.freeFile, 
# 3616 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                                           ((void *)0)
# 3616 "./src/main/io/asyncfatfs/asyncfatfs.c"
                                               );
            openFileCount++;
        }
...
# 3622 "./src/main/io/asyncfatfs/asyncfatfs.c"
        ...
        if (!afatfs_flush()) {
            return 
# 3629 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3629 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        if (afatfs.cacheFlushInProgress) {
            return 
# 3633 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3633 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }

        if (openFileCount > 0) {
            return 
# 3637 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
                  0
# 3637 "./src/main/io/asyncfatfs/asyncfatfs.c"
                       ;
        }
# 3648 "./src/main/io/asyncfatfs/asyncfatfs.c"
    ...
    return 
# 3653 "./src/main/io/asyncfatfs/asyncfatfs.c" 3 4
          1
# 3653 "./src/main/io/asyncfatfs/asyncfatfs.c"
              ;
}
