...
static 
# 62 "./src/main/telemetry/crsf.c" 3 4
      _Bool 
# 62 "./src/main/telemetry/crsf.c"
           crsfTelemetryEnabled;
static uint8_t crsfCrc;
static uint8_t crsfFrame[(32 + 4)];
...
# 303 "./src/main/telemetry/crsf.c" 3 4
_Bool 
# 303 "./src/main/telemetry/crsf.c"
    checkCrsfTelemetryState(void)
{
