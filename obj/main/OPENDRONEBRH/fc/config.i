...
# 35 "./src/main/blackbox/blackbox_io.h"
    BLACKBOX_DEVICE_END
} BlackboxDevice;
...
const featureConfig_t pgResetTemplate_featureConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .enabledFeatures = (FEATURE_TX_PROF_SEL | FEATURE_TRANSPONDER | FEATURE_BLACKBOX | FEATURE_RSSI_ADC | FEATURE_CURRENT_METER | FEATURE_VBAT | FEATURE_TELEMETRY) | (FEATURE_TX_PROF_SEL) }
...
# 518 "./src/main/fc/config.c" 3 4
   _Bool 
# 518 "./src/main/fc/config.c"
        ret = 
# 518 "./src/main/fc/config.c" 3 4
              1
# 518 "./src/main/fc/config.c"
    ...
    if (systemConfig()->current_profile_index == profileIndex) {
        ret = 
# 520 "./src/main/fc/config.c" 3 4
              0
# 520 "./src/main/fc/config.c"
                   ;
    }
    if (profileIndex >= 3) {
        profileIndex = 0;
