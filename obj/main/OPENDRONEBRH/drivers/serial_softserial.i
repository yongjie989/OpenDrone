...
# 147 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 147 "./src/main/drivers/serial_softserial.c"
                                            ;
...
serialPort_t *openSoftSerial(softSerialPortIndex_e portIndex, serialReceiveCallbackPtr rxCallback, void *rxCallbackData, uint32_t baud, portMode_t mode, portOptions_t options)
{
    ...
    if (options & SERIAL_BIDIR) {
        ...
        if (!timerTx || (timerTx->output & TIMER_OUTPUT_N_CHANNEL)) {
            return 
# 269 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 269 "./src/main/drivers/serial_softserial.c"
                      ;
        }
...
# 280 "./src/main/drivers/serial_softserial.c"
        ...
        if (mode & MODE_TX) {
            ...
            if (!tagTx)
                return 
# 291 "./src/main/drivers/serial_softserial.c" 3 4
                      ((void *)0)
# 291 "./src/main/drivers/serial_softserial.c"
                          ;
            ...
            if (!(mode & MODE_RX)) {
                ...
                if (!timerTx)
                    return 
# 298 "./src/main/drivers/serial_softserial.c" 3 4
                          ((void *)0)
# 298 "./src/main/drivers/serial_softserial.c"
                              ;
                softSerial->timerHardware = timerTx;
            } else {
    ...
    softSerial->rxActive = 
# 322 "./src/main/drivers/serial_softserial.c" 3 4
                          0
# 322 "./src/main/drivers/serial_softserial.c"
                               ;
    softSerial->isTransmittingData = 
# 323 "./src/main/drivers/serial_softserial.c" 3 4
                                    0
# 323 "./src/main/drivers/serial_softserial.c"
                                         ;
...
# 342 "./src/main/drivers/serial_softserial.c" 3 4
                                                           ((void *)0)
# 342 "./src/main/drivers/serial_softserial.c"
                                                               , &softSerial->overCb);
        timerChConfigCallbacks(softSerial->timerHardware, &softSerial->edgeCb, 
# 343 "./src/main/drivers/serial_softserial.c" 3 4
                                                                              ((void *)0)
# 343 "./src/main/drivers/serial_softserial.c"
                                                                                  );
    } else {
...
void processTxState(softSerial_t *softSerial)
{
    ...
    if (!softSerial->isTransmittingData) {
        ...
        softSerial->isTransmittingData = 
# 392 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 392 "./src/main/drivers/serial_softserial.c"
                                            ;
...
void prepareForNextRxByte(softSerial_t *softSerial)
{
    ...
    softSerial->rxBitIndex = 0;
    softSerial->isSearchingForStartBit = 
# 434 "./src/main/drivers/serial_softserial.c" 3 4
                                        1
# 434 "./src/main/drivers/serial_softserial.c"
                                            ;
...
# 437 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                 1 
# 437 "./src/main/drivers/serial_softserial.c"
                                                                                                                   : 
# 437 "./src/main/drivers/serial_softserial.c" 3 4
                                                                                                                     0
# 437 "./src/main/drivers/serial_softserial.c"
...
# 510 "./src/main/drivers/serial_softserial.c" 3 4
                        __builtin_offsetof (
# 510 "./src/main/drivers/serial_softserial.c"
                        softSerial_t
# 510 "./src/main/drivers/serial_softserial.c" 3 4
                        , 
# 510 "./src/main/drivers/serial_softserial.c"
...
# 511 "./src/main/drivers/serial_softserial.c" 3 4
   _Bool 
# 511 "./src/main/drivers/serial_softserial.c"
...
# 545 "./src/main/drivers/serial_softserial.c" 3 4
                                      0
# 545 "./src/main/drivers/serial_softserial.c"
                                           ;
        return;
    }
    ...
    if (self->rxEdge == TRAILING) {
        self->rxEdge = LEADING;
        timerChConfigIC(self->timerHardware, inverted ? 
# 557 "./src/main/drivers/serial_softserial.c" 3 4
                                                       0 
# 557 "./src/main/drivers/serial_softserial.c"
                                                                          : 
# 557 "./src/main/drivers/serial_softserial.c" 3 4
                                                                            1
# 557 "./src/main/drivers/serial_softserial.c"
        ...
        timerChConfigIC(self->timerHardware, inverted ? 
# 560 "./src/main/drivers/serial_softserial.c" 3 4
                                                       1 
# 560 "./src/main/drivers/serial_softserial.c"
                                                                         : 
# 560 "./src/main/drivers/serial_softserial.c" 3 4
                                                                           0
# 560 "./src/main/drivers/serial_softserial.c"
...
static const struct serialPortVTable softSerialVTable = {
    ...
    .isConnected = 
# 650 "./src/main/drivers/serial_softserial.c" 3 4
                  ((void *)0)
# 650 "./src/main/drivers/serial_softserial.c"
                      ,
    .writeBuf = 
# 651 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)
# 651 "./src/main/drivers/serial_softserial.c"
                   ,
    .beginWrite = 
# 652 "./src/main/drivers/serial_softserial.c" 3 4
                 ((void *)0)
# 652 "./src/main/drivers/serial_softserial.c"
                     ,
    .endWrite = 
# 653 "./src/main/drivers/serial_softserial.c" 3 4
               ((void *)0)

# 654 "./src/main/drivers/serial_softserial.c"
};
