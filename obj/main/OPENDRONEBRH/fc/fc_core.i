...
# 103 "./src/main/fc/fc_core.c" 3 4
                            0
# 103 "./src/main/fc/fc_core.c"
                                 ;
...
# 110 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 110 "./src/main/fc/fc_core.c"
    isCalibrating(void)
{
...
# 114 "./src/main/fc/fc_core.c"
    ...
    if (sensors(SENSOR_PITOT) && !pitotIsCalibrationComplete()) {
        return 
# 120 "./src/main/fc/fc_core.c" 3 4
              1
# 120 "./src/main/fc/fc_core.c"
                  ;
    }
...
# 126 "./src/main/fc/fc_core.c"
    ...
    if (!accIsCalibrationComplete() && sensors(SENSOR_ACC)) {
        return 
# 131 "./src/main/fc/fc_core.c" 3 4
              1
# 131 "./src/main/fc/fc_core.c"
                  ;
    }
...
static void updateArmingStatus(void)
{
    if ((armingFlags & (ARMED))) {
        ledSet(0, 
# 154 "./src/main/fc/fc_core.c" 3 4
       1
# 154 "./src/main/fc/fc_core.c"
       );
    } else {

        static 
# 157 "./src/main/fc/fc_core.c" 3 4
              _Bool 
# 157 "./src/main/fc/fc_core.c"
...
{
    static 
# 423 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 423 "./src/main/fc/fc_core.c"
               armedBeeperOn = 
# 423 "./src/main/fc/fc_core.c" 3 4
                               0
# 423 "./src/main/fc/fc_core.c"
        ...
        if (isUsingSticksForArming()) {
            if (throttleStatus == THROTTLE_LOW) {
                if (armingConfig()->auto_disarm_delay != 0
                    ...
                    armedBeeperOn = 
# 458 "./src/main/fc/fc_core.c" 3 4
                                   0
# 458 "./src/main/fc/fc_core.c"
                                        ;
                } else {

                    beeper(BEEPER_ARMED);
                    armedBeeperOn = 
# 462 "./src/main/fc/fc_core.c" 3 4
                                   1
# 462 "./src/main/fc/fc_core.c"
                                       ;
                }
            } else {
...
# 480 "./src/main/fc/fc_core.c"
                ...
                beeperSilence();
                armedBeeperOn = 
# 483 "./src/main/fc/fc_core.c" 3 4
                               0
# 483 "./src/main/fc/fc_core.c"
                                    ;
            }
        }
    }
...
void filterRc(
# 639 "./src/main/fc/fc_core.c" 3 4
             _Bool 
# 639 "./src/main/fc/fc_core.c"
                  isRXDataNew)
{
    ...
    static 
# 645 "./src/main/fc/fc_core.c" 3 4
          _Bool 
# 645 "./src/main/fc/fc_core.c"
               filterInitialised;
    ...
    if (!filterInitialised) {
        ...
        filterInitialised = 
# 650 "./src/main/fc/fc_core.c" 3 4
                           1
# 650 "./src/main/fc/fc_core.c"
                               ;
    }
...
void taskGyro(timeUs_t currentTimeUs) {
    ...
    if (gyroConfig()->gyroSync) {
        while (
# 685 "./src/main/fc/fc_core.c" 3 4
              1
# 685 "./src/main/fc/fc_core.c"
                  ) {
            gyroUpdateUs = micros();
...
# 735 "./src/main/fc/fc_core.c"
    ...
    isRXDataNew = 
# 747 "./src/main/fc/fc_core.c" 3 4
                 0
# 747 "./src/main/fc/fc_core.c"
                      ;
...
# 838 "./src/main/fc/fc_core.c"
}


# 840 "./src/main/fc/fc_core.c" 3 4
_Bool 
# 840 "./src/main/fc/fc_core.c"
...
void taskUpdateRxMain(timeUs_t currentTimeUs)
{
    ...
    isRXDataNew = 
# 850 "./src/main/fc/fc_core.c" 3 4
                 1
# 850 "./src/main/fc/fc_core.c"
                     ;
}
