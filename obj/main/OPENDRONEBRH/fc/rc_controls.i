...
# 88 "./src/main/fc/rc_controls.c" 3 4
_Bool 
# 88 "./src/main/fc/rc_controls.c"
    areSticksInApModePosition(uint16_t ap_mode)
{
...
# 123 "./src/main/fc/rc_controls.c" 3 4
_Bool 
# 123 "./src/main/fc/rc_controls.c"
    checkStickPosition(stickPositions_e stickPos)
{
    ...
    for (int i = 0; i < 4; i++) {
        if (((stickPos & mask[i]) != 0) && ((stickPos & mask[i]) != (rcStickPositions & mask[i]))) {
            return 
# 128 "./src/main/fc/rc_controls.c" 3 4
                  0
# 128 "./src/main/fc/rc_controls.c"
                       ;
        }
    }

    return 
# 132 "./src/main/fc/rc_controls.c" 3 4
          1
...
void processRcStickPositions(throttleStatus_e throttleStatus, 
# 154 "./src/main/fc/rc_controls.c" 3 4
                                                             _Bool 
# 154 "./src/main/fc/rc_controls.c"
                                                                  disarm_kill_switch, 
# 154 "./src/main/fc/rc_controls.c" 3 4
                                                                                      _Bool 
# 154 "./src/main/fc/rc_controls.c"
...
# 244 "./src/main/fc/rc_controls.c"
    ...
    if (rcSticks == THR_LO + YAW_CE + PIT_HI + ROL_HI) {
        const 
# 250 "./src/main/fc/rc_controls.c" 3 4
             _Bool 
# 250 "./src/main/fc/rc_controls.c"
...
int32_t getRcStickDeflection(int32_t axis, uint16_t midrc) {
    return ( __extension__ ({ __typeof__(( __extension__ ({ __typeof__(rcData[axis] - midrc) _abs4 = (rcData[axis] - midrc); _abs4 < 0 ? -_abs4 : _abs4; }))) _left5 = (( __extension__ ({ __typeof__(rcData[axis] - midrc) _abs4 = (rcData[axis] - midrc); _abs4 < 0 ? -_abs4 : _abs4; }))); __typeof__(500) _right6 = (500); _left5 < _right6 ? _left5 : _right6; }));
}
