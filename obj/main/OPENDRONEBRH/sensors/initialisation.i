...
# 48 "./src/main/sensors/initialisation.c" 3 4
   _Bool 
# 48 "./src/main/sensors/initialisation.c"
        eepromUpdatePending = 
# 48 "./src/main/sensors/initialisation.c" 3 4
                              0
# 48 "./src/main/sensors/initialisation.c"
...
# 51 "./src/main/sensors/initialisation.c"
    ...
    pitotInit();
# 76 "./src/main/sensors/initialisation.c"
    if (accelerometerConfig()->acc_hardware == ACC_AUTODETECT) {
        ...
        eepromUpdatePending = 
# 78 "./src/main/sensors/initialisation.c" 3 4
                             1
# 78 "./src/main/sensors/initialisation.c"
                                 ;
    }
    ...
    if (barometerConfig()->baro_hardware == BARO_AUTODETECT) {
        ...
        eepromUpdatePending = 
# 84 "./src/main/sensors/initialisation.c" 3 4
                             1
# 84 "./src/main/sensors/initialisation.c"
                                 ;
    }
# 96 "./src/main/sensors/initialisation.c"
    if (pitotmeterConfig()->pitot_hardware == PITOT_AUTODETECT) {
        ...
        eepromUpdatePending = 
# 98 "./src/main/sensors/initialisation.c" 3 4
                             1
# 98 "./src/main/sensors/initialisation.c"
                                 ;
    }
    ...
    return 
# 106 "./src/main/sensors/initialisation.c" 3 4
          1
# 106 "./src/main/sensors/initialisation.c"
              ;
}
