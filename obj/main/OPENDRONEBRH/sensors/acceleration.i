...
# 222 "./src/main/sensors/acceleration.c"
    case ACC_MPU6500:
        ...
        __attribute__ ((fallthrough));
# 266 "./src/main/sensors/acceleration.c"
    default:
    case ACC_NONE:
    ...
    if (accHardware == ACC_NONE) {
        return 
# 275 "./src/main/sensors/acceleration.c" 3 4
              0
# 275 "./src/main/sensors/acceleration.c"
                   ;
    }
    ...
    return 
# 280 "./src/main/sensors/acceleration.c" 3 4
          1
# 280 "./src/main/sensors/acceleration.c"
              ;
}


# 283 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 283 "./src/main/sensors/acceleration.c"
    accInit(uint32_t targetLooptime)
{
    ...
    if (!accDetect(&acc.dev, accelerometerConfig()->acc_hardware)) {
        return 
# 295 "./src/main/sensors/acceleration.c" 3 4
              0
# 295 "./src/main/sensors/acceleration.c"
                   ;
    }
...
static 
# 319 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 319 "./src/main/sensors/acceleration.c"
...
static 
# 324 "./src/main/sensors/acceleration.c" 3 4
      _Bool 
# 324 "./src/main/sensors/acceleration.c"
...
# 386 "./src/main/sensors/acceleration.c" 3 4
                                      0
# 386 "./src/main/sensors/acceleration.c"
                                           ;
            accSamples[axis][X] = 0;
            accSamples[axis][Y] = 0;
            accSamples[axis][Z] = 0;
...
# 578 "./src/main/sensors/acceleration.c" 3 4
_Bool 
# 578 "./src/main/sensors/acceleration.c"
    accIsHealthy(void)
{
    return 
# 580 "./src/main/sensors/acceleration.c" 3 4
          1
# 580 "./src/main/sensors/acceleration.c"
              ;
}
